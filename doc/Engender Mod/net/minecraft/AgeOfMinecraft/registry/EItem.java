...
public class EItem {
  ...
  public static void ENMO() {
    init();
    register();
    BlockDispenser.field_149943_a.func_82595_a(carrier, new BehaviorDefaultDispenseItem() {
          public ItemStack func_82487_b(IBlockSource source, ItemStack stack) {
            EnumFacing enumfacing = (EnumFacing)source.func_189992_e().func_177229_b((IProperty)BlockDispenser.field_176441_a);
            double d0 = source.func_82615_a() + enumfacing.func_82601_c();
            double d1 = ((source.func_180699_d().func_177956_o() + enumfacing.func_96559_d()) + 0.2F);
            double d2 = source.func_82616_c() + enumfacing.func_82599_e();
            Entity entity = ItemCarrier.spawnMob(source.func_82618_k(), stack, d0, d1, d2);
            super.func_82487_b(source, stack);
            return stack;
          }
        });
  }
  ...
  public static void init() {
    ...
    witheredNetherStar = (Item)(new ItemSimpleFoiled()).func_77637_a(ETab.engender).func_77655_b("withered_nether_star").setRegistryName("withered_nether_star");
  ...
  public static void registerRenders() {
    ItemModelMesher renderItem = Minecraft.func_71410_x().func_175599_af().func_175037_a();
    int i;
    for (i = 0; i <= 9; i++)
  ...
  public static void registerItemSubbed(ItemModelMesher renderItem, Item item, int meta) {
    renderItem.func_178086_a(item, meta, new ModelResourceLocation("ageofminecraft:" + item.func_77658_a().substring(5), "inventory"));
  }
}
