...
public class EEntity {
  ...
  public static void registerEntity() {
    ...
    EntityRegistry.addSpawn(EntityEndermite.class, 20, 1, 4, EnumCreatureType.MONSTER, new Biome[] { Biomes.field_76779_k });
    EntityRegistry.addSpawn(EntityShulker.class, 1, 1, 1, EnumCreatureType.MONSTER, new Biome[] { Biomes.field_76779_k });
    EntityRegistry.addSpawn(EntityBlaze.class, 20, 1, 4, EnumCreatureType.MONSTER, new Biome[] { Biomes.field_76778_j });
    EntityRegistry.addSpawn(EntityWitherSkeleton.class, 10, 1, 4, EnumCreatureType.MONSTER, new Biome[] { Biomes.field_76778_j });
  }
