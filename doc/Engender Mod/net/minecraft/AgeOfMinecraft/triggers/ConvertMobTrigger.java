...
public class ConvertMobTrigger implements ICriterionTrigger<ConvertMobTrigger.Instance> {
  ...
  static class Listeners {
    ...
    private final Set<ICriterionTrigger.Listener<ConvertMobTrigger.Instance>> listeners = Sets.newHashSet();
    ...
    public void trigger(EntityPlayerMP player, EntityTameBase entity) {
      ...
      for (ICriterionTrigger.Listener<ConvertMobTrigger.Instance> listener : this.listeners) {
        if (((ConvertMobTrigger.Instance)listener.func_192158_a()).test(player, entity)) {
          if (list == null)
