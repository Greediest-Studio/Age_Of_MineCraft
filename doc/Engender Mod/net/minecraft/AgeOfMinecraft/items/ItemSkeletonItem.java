...
public class ItemSkeletonItem extends ItemVanillaTier {
  public ItemSkeletonItem() {
    super(2, 20, 24, "skeleton");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    entityliving.func_184201_a(EntityEquipmentSlot.MAINHAND, new ItemStack((Item)Items.field_151031_f));
    if (!worldIn.field_72995_K) {
