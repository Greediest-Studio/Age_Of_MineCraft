    ...
    if (!worldIn.field_72995_K) {
      ...
      while (i > 0) {
        ...
        if (!worldIn.func_82736_K().func_82766_b("disableExpItemDrops"))
          entityliving.field_70170_p.func_72838_d((Entity)new EntityXPOrb(entityliving.field_70170_p, entityliving.field_70165_t, entityliving.field_70163_u + entityliving.func_70047_e() + 25.0D, entityliving.field_70161_v, j)); 
      } 
    } 
