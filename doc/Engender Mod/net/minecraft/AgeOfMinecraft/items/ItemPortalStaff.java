...
public class ItemPortalStaff extends ItemBEItem {
  ...
  public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityPlayer playerIn) {
    ...
    playerIn.func_184811_cZ().func_185145_a(this, 600 + stack.func_77960_j() * 200);
    ...
    if (!worldIn.field_72995_K) {
      ...
      portal.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(1000.0D + portal.getMetaData() * 500.0D);
      portal.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(20.0D + portal.getMetaData() * 5.0D);
