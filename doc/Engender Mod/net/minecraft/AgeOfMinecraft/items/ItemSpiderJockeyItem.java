...
public class ItemSpiderJockeyItem extends ItemVanillaTier {
  public ItemSpiderJockeyItem() {
    super(2, 38, 16, "spiderjockey");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    if (entityliving != null) {
      ...
      pos = pos.func_177972_a(facing);
      entitymount.func_70012_b(pos.func_177958_n() + 0.5D, pos.func_177956_o(), pos.func_177952_p() + 0.5D, MathHelper.func_76142_g(worldIn.field_73012_v.nextFloat() * 360.0F), 0.0F);
      entitymount.field_70759_as = entitymount.field_70177_z;
      entitymount.field_70761_aq = entitymount.field_70177_z;
      entitymount.func_180482_a(worldIn.func_175649_E(new BlockPos((Entity)entityliving)), null);
      worldIn.func_72838_d((Entity)entitymount);
      entitymount.func_184220_m((Entity)entityliving);
      entitymount.setOwnerId(playerIn.func_110124_au());
