...
public class EntityDreadSpawn extends EntityTameBase implements Light {
  private static final DataParameter<Byte> CLIMBING = EntityDataManager.func_187226_a(EntityDreadSpawn.class, DataSerializers.field_187191_a);
  
  private static boolean hasMerged;
  
  public EntityDreadSpawn(World par1World) {
    super(par1World);
    func_70105_a(0.425F, 0.425F);
  ...
  public void func_70636_d() {
    ...
    List<EntityDreadSpawn> dreadspawns = this.field_70170_p.func_72872_a(getClass(), func_174813_aQ().func_186662_g(0.5D));
    if (!this.field_70170_p.field_72995_K && 
      !dreadspawns.isEmpty() && 
      dreadspawns.size() >= 5 && !hasMerged) {
      hasMerged = true;
      for (int i = 0; i < 5 && func_184191_r((Entity)dreadspawns.get(i)); i++)
      ...
      greaterspawn.setOwnerId(func_184753_b());
    ...
    if (!list.isEmpty() && list.size() >= 5 && (this.field_70173_aa + func_145782_y()) % 20 == 0)
      for (int i1 = 0; i1 < list.size(); i1++) {
        ...
        if (entity.func_70089_S() && entity instanceof EntityDreadSpawn) {
