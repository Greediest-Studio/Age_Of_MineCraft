...
public class EntityAbygolem extends EntityTameBase implements Light {
  ...
  public EntityAbygolem(World par1World) {
    ...
    this.timeUntilNextEgg = 200 + this.field_70146_Z.nextInt(200);
  }
  ...
  public EntityTameBase spawnBaby(EntityTameBase par1idleTimeable) {
    return new EntityAbygolem(this.field_70170_p);
  }
  ...
  public void func_70636_d() {
    ...
    if (!this.field_70170_p.field_72995_K && !func_70631_g_() && --this.timeUntilNextEgg <= 0) {
      ...
      func_70099_a(isHero() ? new ItemStack(ACItems.abyssalnite_ingot, 1) : new ItemStack(ACItems.crystal_fragment, 1, 12), this.field_70146_Z.nextFloat() * this.field_70131_O);
      this.timeUntilNextEgg = 400 + this.field_70146_Z.nextInt(1200);
    } 
  }
