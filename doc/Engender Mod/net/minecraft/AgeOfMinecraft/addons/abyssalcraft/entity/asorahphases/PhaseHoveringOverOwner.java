...
public class PhaseHoveringOverOwner extends PhaseBaseFriendly {
  ...
  public PhaseHoveringOverOwner(EntityDragonBoss dragonIn) {
    super(dragonIn);
  }
  ...
  public void doClientRenderEffects() {
    ...
    for (int i = 0; i < 8; i++) {
      ...
      this.dragon.field_70170_p.func_175688_a(EnumParticleTypes.VILLAGER_HAPPY, d3, d4, d5, -vec3d.field_72450_a * 0.07999999821186066D + this.dragon.field_70159_w, -vec3d.field_72448_b * 0.30000001192092896D + this.dragon.field_70181_x, -vec3d.field_72449_c * 0.07999999821186066D + this.dragon.field_70179_y, new int[0]);
  ...
  public void doLocalUpdate() {
    ...
    if (this.field_188685_b.func_186679_c(this.dragon.field_70165_t, this.dragon.field_70163_u, this.dragon.field_70161_v) < 9.0D) {
      ((PhaseBreathing)this.dragon.getPhaseManager().<PhaseBreathing>getPhase(PhaseListAsorah.SITTING_FLAMING)).func_188663_j();
  ...
  public PhaseListAsorah<PhaseHoveringOverOwner> getPhaseList() {
    return PhaseListAsorah.LANDING;
  }
}
