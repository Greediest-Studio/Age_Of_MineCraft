...
public class ItemLesserDreadbeastItem extends ItemAbyTier {
  public ItemLesserDreadbeastItem() {
    super(4, 360, 8, "lesserdreadbeast");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityLesserDreadbeast entityliving = new EntityLesserDreadbeast(worldIn);
    ...
    if (entityliving != null) {
      ...
      entityliving.func_184185_a(ESound.amalgamate, 5.0F, 1.0F);
