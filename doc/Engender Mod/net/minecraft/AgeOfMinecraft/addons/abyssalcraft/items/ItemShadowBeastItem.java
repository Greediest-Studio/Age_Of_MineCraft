...
public class ItemShadowBeastItem extends ItemAbyTier {
  public ItemShadowBeastItem() {
    super(4, 120, 16, "shadowbeast");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityShadowBeast entityliving = new EntityShadowBeast(worldIn);
