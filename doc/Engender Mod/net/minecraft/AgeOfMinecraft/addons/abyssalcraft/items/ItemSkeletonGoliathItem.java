...
public class ItemSkeletonGoliathItem extends ItemAbyTier {
  public ItemSkeletonGoliathItem() {
    super(4, 90, 12, "gskeleton");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntitySkeletonGoliath entityliving = new EntitySkeletonGoliath(worldIn);
