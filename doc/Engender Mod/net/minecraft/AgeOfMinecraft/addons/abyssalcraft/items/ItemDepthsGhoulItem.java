...
public class ItemDepthsGhoulItem extends ItemAbyTier {
  public ItemDepthsGhoulItem() {
    super(2, 24, 20, "depthsghoul");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityDepthsGhoul entityliving = new EntityDepthsGhoul(worldIn);
