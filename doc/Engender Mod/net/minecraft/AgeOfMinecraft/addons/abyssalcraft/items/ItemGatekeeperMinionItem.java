...
public class ItemGatekeeperMinionItem extends ItemAbyTier {
  public ItemGatekeeperMinionItem() {
    super(4, 300, 12, "gatekeeperminion");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityGatekeeperMinion entityliving = new EntityGatekeeperMinion(worldIn);
