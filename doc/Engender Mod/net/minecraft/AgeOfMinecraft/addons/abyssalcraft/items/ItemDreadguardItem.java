...
public class ItemDreadguardItem extends ItemAbyTier {
  public ItemDreadguardItem() {
    super(4, 180, 16, "dreadguard");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityDreadguard entityliving = new EntityDreadguard(worldIn);
