...
public class ItemDreadgolemItem extends ItemAbyTier {
  public ItemDreadgolemItem() {
    super(2, 20, 24, "dreadgolem");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityDreadgolem entityliving = new EntityDreadgolem(worldIn);
    ...
    if (entityliving != null) {
      ...
      entityliving.func_184185_a(ESound.woodHit, 5.0F, 1.0F);
