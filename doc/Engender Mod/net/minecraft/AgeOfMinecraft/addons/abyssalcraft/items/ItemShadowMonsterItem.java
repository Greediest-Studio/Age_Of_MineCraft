...
public class ItemShadowMonsterItem extends ItemAbyTier {
  public ItemShadowMonsterItem() {
    super(3, 45, 24, "shadowmonster");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityShadowMonster entityliving = new EntityShadowMonster(worldIn);
