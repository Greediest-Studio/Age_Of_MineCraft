...
public class ItemAbyssalPortalStaff extends ItemBEItem {
  ...
  public void func_77624_a(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
    tooltip.add("Summon a portal of horrors to obliterate");
    tooltip.add("your enemies and build your eldritch army");
  ...
  public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityPlayer playerIn) {
    ...
    playerIn.func_184811_cZ().func_185145_a((Item)this, 900 + stack.func_77960_j() * 300);
    ...
    portal.func_184185_a(ESound.portalMake, 100.0F, 1.0F);
    portal.func_184185_a(ESound.portalAmbient, 5.0F, 1.0F);
    if (!worldIn.field_72995_K) {
      worldIn.func_72838_d((Entity)portal);
      portal.setMetaData(stack.func_77960_j());
      portal.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(1000.0D + portal.getMetaData() * 750.0D);
      portal.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(20.0D + portal.getMetaData() * 7.5D);
