...
public class ItemLesserShoggothItem extends ItemAbyTier {
  public ItemLesserShoggothItem() {
    super(3, 120, 16, "shoggoth");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityLesserShoggoth entityliving = new EntityLesserShoggoth(worldIn);
