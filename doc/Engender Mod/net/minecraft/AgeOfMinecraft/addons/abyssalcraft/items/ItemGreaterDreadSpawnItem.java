...
public class ItemGreaterDreadSpawnItem extends ItemAbyTier {
  public ItemGreaterDreadSpawnItem() {
    super(3, 60, 24, "greaterdreadspawn");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityGreaterDreadSpawn entityliving = new EntityGreaterDreadSpawn(worldIn);
