...
public class ItemDreadSpawnItem extends ItemAbyTier {
  public ItemDreadSpawnItem() {
    super(2, 10, 32, "dreadspawn");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityDreadSpawn entityliving = new EntityDreadSpawn(worldIn);
