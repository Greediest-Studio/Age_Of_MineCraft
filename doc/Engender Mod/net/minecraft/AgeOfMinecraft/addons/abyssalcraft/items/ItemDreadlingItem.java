...
public class ItemDreadlingItem extends ItemAbyTier {
  public ItemDreadlingItem() {
    super(2, 16, 28, "dreadling");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityDreadling entityliving = new EntityDreadling(worldIn);
