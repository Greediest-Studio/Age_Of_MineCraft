...
public class ItemChagarothItem extends ItemAbyTier {
  public ItemChagarothItem() {
    super(4, 900, 3, "chagaroth");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityChagaroth entityliving = new EntityChagaroth(worldIn);
