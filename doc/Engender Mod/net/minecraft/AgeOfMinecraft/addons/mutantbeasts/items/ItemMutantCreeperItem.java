...
public class ItemMutantCreeperItem extends ItemMutantTier {
  public ItemMutantCreeperItem() {
    super(4, 240, 8, "mutantcreeper");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityMutantCreeper entityliving = new EntityMutantCreeper(worldIn);
