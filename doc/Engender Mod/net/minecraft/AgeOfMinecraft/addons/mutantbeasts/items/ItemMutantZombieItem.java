...
public class ItemMutantZombieItem extends ItemMutantTier {
  public ItemMutantZombieItem() {
    super(4, 360, 6, "mutantzombie");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityMutantZombie entityliving = new EntityMutantZombie(worldIn);
