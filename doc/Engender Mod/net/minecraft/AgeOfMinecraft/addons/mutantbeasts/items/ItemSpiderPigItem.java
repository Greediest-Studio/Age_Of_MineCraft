...
public class ItemSpiderPigItem extends ItemMutantTier {
  public ItemSpiderPigItem() {
    super(3, 40, 20, "spiderpig");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntitySpiderPig entityliving = new EntitySpiderPig(worldIn);
