...
public class ItemMutantSnowGolemItem extends ItemMutantTier {
  public ItemMutantSnowGolemItem() {
    super(3, 60, 12, "mutantsnowgolem");
  }
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityMutantSnowGolem entityliving = new EntityMutantSnowGolem(worldIn);
    ...
    if (entityliving != null) {
      ...
      entityliving.func_184185_a(ESound.createMob, 10.0F, 1.0F);
