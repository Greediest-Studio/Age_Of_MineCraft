...
public class MutantBeastsAddon {
  ...
  public void postInit(FMLPostInitializationEvent e) {
    if (Loader.isModLoaded("mutantbeasts")) {
      ...
      EItem.fusionPigSpider.func_77637_a(ETab.mutant);
      EItem.fusionMutantSnowGolem.func_77637_a(ETab.mutant);
      EItem.fusionMutantCreeper.func_77637_a(ETab.mutant);
      EItem.fusionMutantEnderman.func_77637_a(ETab.mutant);
      EItem.fusionMutantSkeleton.func_77637_a(ETab.mutant);
      EItem.fusionMutantZombie.func_77637_a(ETab.mutant);
      EItem.pigSpiderItem.func_77637_a(ETab.mutant);
      EItem.mutantSnowGolemItem.func_77637_a(ETab.mutant);
      EItem.mutantCreeperItem.func_77637_a(ETab.mutant);
      EItem.mutantEndermanItem.func_77637_a(ETab.mutant);
      EItem.mutantSkeletonItem.func_77637_a(ETab.mutant);
      EItem.mutantZombieItem.func_77637_a(ETab.mutant);
