...
public class ItemChaosGuardianItem extends ItemTierItem {
  ...
  public EnumActionResult func_180614_a(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    entityliving.func_70012_b(pos.func_177958_n() + 0.5D, pos.func_177956_o() + 60.0D, pos.func_177952_p() + 0.5D, MathHelper.func_76142_g(worldIn.field_73012_v.nextFloat() * 360.0F), 0.0F);
    ...
    if (!worldIn.field_72995_K) {
      ...
      while (i > 0) {
        ...
        if (!worldIn.func_82736_K().func_82766_b("disableExpItemDrops"))
          entityliving.field_70170_p.func_72838_d((Entity)new EntityXPOrb(entityliving.field_70170_p, entityliving.field_70165_t, entityliving.field_70163_u + entityliving.func_70047_e() + 5.0D, entityliving.field_70161_v, j)); 
      } 
    } 
    if (entityliving != null) {
      entityliving.setOwnerId(playerIn.func_110124_au());
      entityliving.func_70642_aH();
      entityliving.func_184185_a(ESound.createMob, 10.0F, 0.5F);
      entityliving.func_184185_a(ESound.createBossMob, Float.MAX_VALUE, 0.75F);
