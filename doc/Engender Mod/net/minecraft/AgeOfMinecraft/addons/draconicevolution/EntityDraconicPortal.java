...
public class EntityDraconicPortal extends EntityTameBase implements IEntityMultiPart, Massive, Armored, Structure {
  private static final DataParameter<Integer> TOWER1_TARGET = EntityDataManager.func_187226_a(EntityDraconicPortal.class, DataSerializers.field_187192_b);
  
  private static final DataParameter<Integer> TOWER2_TARGET = EntityDataManager.func_187226_a(EntityDraconicPortal.class, DataSerializers.field_187192_b);
  
  private static final DataParameter<Integer> TOWER3_TARGET = EntityDataManager.func_187226_a(EntityDraconicPortal.class, DataSerializers.field_187192_b);
  
  private static final DataParameter<Integer> TOWER4_TARGET = EntityDataManager.func_187226_a(EntityDraconicPortal.class, DataSerializers.field_187192_b);
  ...
  private static final DataParameter<Integer> LIGHTNINGTIMER = EntityDataManager.func_187226_a(EntityDraconicPortal.class, DataSerializers.field_187192_b);
  
  private static final DataParameter<Integer> METADATA = EntityDataManager.func_187226_a(EntityDraconicPortal.class, DataSerializers.field_187192_b);
  ...
  public EntityDraconicPortal(World worldIn) {
    ...
    func_184185_a(ESound.portalMake, 100.0F, 0.9F);
    func_184185_a(ESound.portalAmbient, 5.0F, 0.75F);
  ...
  public void func_70636_d() {
      ...
      for (int i = 0; i < 4; i++) {
        ...
        if (this.field_70173_aa > 80 && func_70089_S() && this.field_70173_aa >= this.towerUpdate[i]) {
          ...
          if (i1 > 0) {
            ...
            if (entity != null && entity.func_70089_S() && func_70068_e(entity) <= func_110148_a(SharedMonsterAttributes.field_111265_b).func_111125_b() * func_110148_a(SharedMonsterAttributes.field_111265_b).func_111125_b() && func_70685_l(entity)) {
            ...
            List<EntityLivingBase> list1 = this.field_70170_p.func_175647_a(EntityLivingBase.class, func_174813_aQ().func_186662_g(func_110148_a(SharedMonsterAttributes.field_111264_e).func_111126_e()), Predicates.and(new Predicate[] { EntitySelectors.field_94557_a }));
    ...
    if (this.field_70170_p.field_72995_K)
      for (int i = 0; i < 3 && this.field_70173_aa > 60; i++) {
        ...
        this.field_70170_p.func_175688_a(EnumParticleTypes.DRAGON_BREATH, this.field_70165_t + (this.field_70146_Z.nextDouble() - 0.5D) * this.field_70130_N, this.field_70163_u + 0.8D, this.field_70161_v + (this.field_70146_Z.nextDouble() - 0.5D) * this.field_70130_N, 0.0D, 0.05D, 0.0D, new int[0]);
        this.field_70170_p.func_175688_a(EnumParticleTypes.DRAGON_BREATH, this.field_70165_t + (this.field_70146_Z.nextDouble() - 0.5D) * this.field_70130_N, this.field_70163_u + 0.8D, this.field_70161_v + (this.field_70146_Z.nextDouble() - 0.5D) * this.field_70130_N, 0.0D, 0.05D, 0.0D, new int[0]);
        this.field_70170_p.func_175682_a(EnumParticleTypes.REDSTONE, true, this.field_70165_t + 3.25D + f + this.field_70146_Z.nextDouble() - 0.5D, this.field_70163_u + 4.0D + this.field_70146_Z.nextDouble() - 0.5D, this.field_70161_v + 3.25D + f + this.field_70146_Z.nextDouble() - 0.5D, f * 0.1D, 0.02D, f * 0.1D, new int[0]);
        this.field_70170_p.func_175682_a(EnumParticleTypes.REDSTONE, true, this.field_70165_t + 3.25D + f + this.field_70146_Z.nextDouble() - 0.5D, this.field_70163_u + 4.0D + this.field_70146_Z.nextDouble() - 0.5D, this.field_70161_v - 3.25D - f + this.field_70146_Z.nextDouble() - 0.5D, f * 0.1D, 0.02D, f * 0.1D, new int[0]);
        this.field_70170_p.func_175682_a(EnumParticleTypes.REDSTONE, true, this.field_70165_t - 3.25D - f + this.field_70146_Z.nextDouble() - 0.5D, this.field_70163_u + 4.0D + this.field_70146_Z.nextDouble() - 0.5D, this.field_70161_v - 3.25D - f + this.field_70146_Z.nextDouble() - 0.5D, f * 0.1D, 0.02D, f * 0.1D, new int[0]);
        this.field_70170_p.func_175682_a(EnumParticleTypes.REDSTONE, true, this.field_70165_t - 3.25D - f + this.field_70146_Z.nextDouble() - 0.5D, this.field_70163_u + 4.0D + this.field_70146_Z.nextDouble() - 0.5D, this.field_70161_v + 3.25D + f + this.field_70146_Z.nextDouble() - 0.5D, f * 0.1D, 0.02D, f * 0.1D, new int[0]);
      }  
    ...
    if ((this.field_70173_aa + func_145782_y()) % 894 == 0)
      func_184185_a(ESound.portalAmbient, 5.0F, 0.75F); 
    if (this.field_70173_aa + func_145782_y() > 60)
      if ((this.field_70173_aa + func_145782_y()) % ((getJukeboxToDanceTo() != null) ? 10 : ((getMetaData() > 2) ? 25 : 50)) == 0 && this.field_70146_Z.nextInt((getJukeboxToDanceTo() != null) ? 5 : 10) == 0) {
        EntityBat bat;
        ...
        float pitch = func_70647_i();
        func_184185_a(ESound.portalWhoosh, 10.0F, pitch + 1.5F);
        func_184185_a(ESound.portalWhoosh, 10.0F, pitch + 1.6F);
        func_184185_a(ESound.portalWhoosh, 10.0F, pitch + 1.7F);
        func_184185_a(ESound.portalWhoosh, 10.0F, pitch + 1.8F);
        func_184185_a(ESound.portalWhoosh, 10.0F, pitch + 1.9F);
        int i = 0;
          ...
          case 4:
            switch (this.field_70146_Z.nextInt(7)) {
              ...
              case 4:
                ...
                break;
              case 5:
                enderdragon = new EntityEnderDragon(this.field_70170_p);
                enderdragon.func_70012_b(this.field_70165_t + (this.field_70146_Z.nextFloat() * 4.0F - 2.0F), this.field_70163_u + 1.5D, this.field_70161_v + (this.field_70146_Z.nextFloat() * 4.0F - 2.0F), 0.0F, 0.0F);
                if (!isWild())
                  enderdragon.setOwnerId(func_184753_b()); 
                enderdragon.func_180482_a(this.field_70170_p.func_175649_E(new BlockPos((Entity)enderdragon)), null);
                if (!this.field_70170_p.field_72995_K)
                  this.field_70170_p.func_72838_d((Entity)enderdragon); 
                break;
              case 6:
  ...
  public void fireLightning(Entity entity, double x, double y, double z) {
    ...
    double d7 = entity.field_70163_u + 1.0D - y;
    ...
    if (this.field_70146_Z.nextBoolean()) {
      if (entity != null && entity.func_70089_S()) {
        ...
        switch (this.field_70146_Z.nextInt(7)) {
          case 0:
          case 1:
            entityGuardianProjectile1 = new EntityGuardianProjectile(this.field_70170_p, 1, (EntityLivingBase)entity, 5.0F + this.field_70146_Z.nextFloat() * 8.0F, (Entity)this);
            entityGuardianProjectile1.func_82149_j((Entity)this);
            entityGuardianProjectile1.field_70165_t = x;
            entityGuardianProjectile1.field_70163_u = y;
            entityGuardianProjectile1.field_70161_v = z;
            entityGuardianProjectile1.func_70012_b(x, y, z, this.field_70177_z, this.field_70125_A);
            entityGuardianProjectile1.shooter = (Entity)this;
            entityGuardianProjectile1.target = (EntityLivingBase)entity;
            entityGuardianProjectile1.field_70159_w = d6 / d9 * 5.0D;
            entityGuardianProjectile1.field_70181_x = d7 / d9 * 5.0D;
            entityGuardianProjectile1.field_70179_y = d8 / d9 * 5.0D;
            this.field_70170_p.func_72838_d(entityGuardianProjectile1);
            return;
          case 2:
            entityGuardianProjectile1 = new EntityGuardianProjectile(this.field_70170_p, 3, (EntityLivingBase)entity, 5.0F + this.field_70146_Z.nextFloat() * 2.0F, (Entity)this);
            entityGuardianProjectile1.func_82149_j((Entity)this);
            entityGuardianProjectile1.field_70165_t = x;
            entityGuardianProjectile1.field_70163_u = y;
            entityGuardianProjectile1.field_70161_v = z;
            ...
            return;
          case 3:
            entityGuardianProjectile1 = new EntityGuardianProjectile(this.field_70170_p, 4, (EntityLivingBase)entity, 5.0F + this.field_70146_Z.nextFloat() * 10.0F, (Entity)this);
            entityGuardianProjectile1.func_82149_j((Entity)this);
            entityGuardianProjectile1.field_70165_t = x;
            entityGuardianProjectile1.field_70163_u = y;
            entityGuardianProjectile1.field_70161_v = z;
            ...
            return;
          case 4:
            entityGuardianProjectile1 = new EntityGuardianProjectile(this.field_70170_p, 5, (EntityLivingBase)entity, 5.0F + this.field_70146_Z.nextFloat() * 10.0F, (Entity)this);
            entityGuardianProjectile1.func_82149_j((Entity)this);
            entityGuardianProjectile1.field_70165_t = x;
            entityGuardianProjectile1.field_70163_u = y;
            entityGuardianProjectile1.field_70161_v = z;
          ...
          case 5:
            for (i = 10; i > 0; i--) {
              EntityGuardianProjectile entityGuardianProjectile = new EntityGuardianProjectile(this.field_70170_p, 6, (EntityLivingBase)entity, (5.0F + this.field_70146_Z.nextFloat() * 10.0F) / 2.0F, (Entity)this);
              entityGuardianProjectile.func_82149_j((Entity)this);
              ...
              entityGuardianProjectile.field_70159_w = Math.sin(randDir) * speed;
              entityGuardianProjectile.field_70179_y = Math.cos(randDir) * speed;
              entityGuardianProjectile.func_70012_b(x, y, z, this.field_70177_z, this.field_70125_A);
        ...
        EntityGuardianProjectile projectile = new EntityGuardianProjectile(this.field_70170_p, 6, (EntityLivingBase)entity, (5.0F + this.field_70146_Z.nextFloat() * 10.0F) / 2.0F, (Entity)this);
        projectile.func_82149_j((Entity)this);
        projectile.field_70165_t = x;
        projectile.field_70163_u = y;
        projectile.field_70161_v = z;
        projectile.func_70012_b(x, y, z, this.field_70177_z, this.field_70125_A);
        projectile.shooter = (Entity)this;
        projectile.target = (EntityLivingBase)entity;
        projectile.field_70159_w = d6 / d9 * 5.0D;
        projectile.field_70181_x = d7 / d9 * 5.0D;
        projectile.field_70179_y = d8 / d9 * 5.0D;
  ...
  protected void func_70609_aI() {
    ...
    if (this.field_70725_aQ == 1) {
      ...
      if (!this.field_70170_p.field_72995_K)
        func_70099_a(new ItemStack(EItem.draconicPortalStaff, 1, getMetaData()), 1.0F); 
