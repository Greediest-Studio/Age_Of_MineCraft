...
public class RenderPolarBear extends RenderLiving<EntityPolarBear> {
  ...
  public RenderPolarBear(RenderManager p_i47132_1_) {
    ...
    func_177094_a(new LayerArrowCustomSized((RenderLivingBase<?>)this, 0.8F));
    func_177094_a(new LayerCustomHeadEngender(((ModelPolarBear)this.field_77045_g).field_78150_a, ((ModelPolarBear)this.field_77045_g).field_78150_a));
