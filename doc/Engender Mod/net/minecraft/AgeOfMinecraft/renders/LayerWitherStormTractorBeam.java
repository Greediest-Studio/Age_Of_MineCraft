...
public class LayerWitherStormTractorBeam implements LayerRenderer<EntityLivingBase> {
  ...
  public void func_177214_a(EntityWitherStormHead p_177214_1_, float p_177214_2_, float p_177214_3_, float p_177214_4_, float p_177214_5_, float p_177214_6_, float p_177214_7_, float p_177214_8_) {
    if (p_177214_1_ != null && !p_177214_1_.func_82150_aj()) {
      GlStateManager.func_179094_E();
      boolean flag = p_177214_1_.func_82150_aj();
      GlStateManager.func_179132_a(!flag);
      ((ModelWitherStormHead)this.witherRenderer.func_177087_b()).BackMouth.func_78794_c(0.0625F);
      GlStateManager.func_179114_b(90.0F, 1.0F, 0.0F, 0.0F);
      GlStateManager.func_179152_a(1.5F, 18.0F, 1.5F);
      GlStateManager.func_179109_b(0.025F, -0.1F, 0.475F);
      this.witherRenderer.func_110776_a(witherTextures);
      GlStateManager.func_179128_n(5890);
      GlStateManager.func_179096_D();
      float f = p_177214_1_.field_70173_aa + p_177214_4_;
      GlStateManager.func_179109_b(0.0F, f * -0.005F, 0.0F);
  ...
  public void func_177141_a(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_, float p_177141_5_, float p_177141_6_, float p_177141_7_, float p_177141_8_) {
    func_177214_a((EntityWitherStormHead)p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_, p_177141_6_, p_177141_7_, p_177141_8_);
  }
}
