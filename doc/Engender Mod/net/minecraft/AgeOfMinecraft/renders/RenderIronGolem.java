...
public class RenderIronGolem extends RenderLiving<EntityIronGolem> {
  ...
  public RenderIronGolem(RenderManager p_i46133_1_) {
    ...
    func_177094_a(new LayerIronGolemFlower(this));
    func_177094_a(new LayerArrowCustomSized((RenderLivingBase<?>)this, 1.0F));
    func_177094_a(new LayerCustomHeadEngender(regularmodel.ironGolemHead, cmmmodel.Head));
  ...
  protected void applyRotations(EntityIronGolem entityLiving, float p_77043_2_, float p_77043_3_, float partialTicks) {
    ...
    if (entityLiving.field_70725_aQ > 0) {
      ...
      if (EngenderConfig.mobs.useMobTalkerModels) {
        ...
        GlStateManager.func_179109_b(f * 0.5F, 0.0F, 0.0F);
      } 
    } else {
