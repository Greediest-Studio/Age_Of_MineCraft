...
public class LayerDarknessExplosion implements LayerRenderer<EntityDarkness> {
  public void doRenderLayer(EntityDarkness entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    if (entitylivingbaseIn.deathTicks > 0) {
      ...
      for (int i = 0; i < (f + f * f) / 2.0F * 60.0F; i++) {
        ...
        bufferbuilder.func_181662_b(0.0D, 0.0D, 0.0D).func_181669_b(255, 0, 255, (int)(255.0F * (1.0F - f1))).func_181675_d();
        bufferbuilder.func_181662_b(-0.866D * f3, f2, (-0.5F * f3)).func_181669_b(255, 0, 255, 0).func_181675_d();
        bufferbuilder.func_181662_b(0.866D * f3, f2, (-0.5F * f3)).func_181669_b(255, 0, 255, 0).func_181675_d();
        bufferbuilder.func_181662_b(0.0D, f2, (1.0F * f3)).func_181669_b(255, 0, 255, 0).func_181675_d();
        bufferbuilder.func_181662_b(-0.866D * f3, f2, (-0.5F * f3)).func_181669_b(255, 0, 255, 0).func_181675_d();
