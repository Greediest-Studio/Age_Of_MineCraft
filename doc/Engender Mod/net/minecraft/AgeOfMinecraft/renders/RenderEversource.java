...
public class RenderEversource extends RenderLiving<EntityEversource> {
  ...
  public RenderEversource(RenderManager renderManagerIn) {
    ...
    func_177094_a(new LayerEversource((RenderLivingBase<?>)this));
    func_177094_a(new LayerCustomHeadEngender(((ModelChicken)this.field_77045_g).field_78142_a, ((ModelChicken)this.field_77045_g).field_78142_a));
