...
public class RenderWither extends RenderLiving<EntityWither> {
  ...
  public RenderWither(RenderManager renderManagerIn) {
    ...
    func_177094_a(new LayerWitherAura(this));
    func_177094_a(new LayerArrowCustomSized((RenderLivingBase<?>)this, 0.5F));
    func_177094_a(new LayerCustomHeadEngender(regularmodel.heads[0], regularmodel.heads[0]));
  ...
  protected void preRenderCallback(EntityWither entitylivingbaseIn, float partialTickTime) {
    ...
    float f11 = 1.0F + MathHelper.func_76126_a(f1 * 100.0F) * f1 * 0.01F;
