...
public class EntityWitherStormTentacleDevourer extends EntityTameBase implements Massive, Armored, Flying, Undead {
  ...
  public boolean func_70652_k(Entity entityIn) {
    if (super.func_70652_k(entityIn)) {
      ...
      List<EntityLivingBase> list1 = this.field_70170_p.func_175647_a(EntityLivingBase.class, entityIn.func_174813_aQ().func_186662_g(6.0D), Predicates.and(new Predicate[] { EntitySelectors.field_180132_d }));
  ...
  public void func_70636_d() {
    ...
    if (this.residentWitherStorm != null) {
      ...
      if (this.residentWitherStorm.doesntContainACommandBlock()) {
        if (this.residentWitherStorm.tentacledevourer1 != null && this == this.residentWitherStorm.tentacledevourer1)
          func_70012_b(this.residentWitherStorm.field_70165_t, this.residentWitherStorm.field_70163_u + 10.0D, this.residentWitherStorm.field_70161_v - oned, 0.0F, 0.0F); 
        if (this.residentWitherStorm.tentacledevourer2 != null && this == this.residentWitherStorm.tentacledevourer2)
          func_70012_b(this.residentWitherStorm.field_70165_t, this.residentWitherStorm.field_70163_u + 10.0D, this.residentWitherStorm.field_70161_v + oned, 0.0F, 0.0F); 
      } else {
        if (this.residentWitherStorm.tentacledevourer1 != null && this == this.residentWitherStorm.tentacledevourer1)
          func_70012_b(this.residentWitherStorm.field_70165_t - (twod * -12.0F), this.residentWitherStorm.field_70163_u + 10.0D, this.residentWitherStorm.field_70161_v - (oned * -12.0F), 0.0F, 0.0F); 
        if (this.residentWitherStorm.tentacledevourer2 != null && this == this.residentWitherStorm.tentacledevourer2)
          func_70012_b(this.residentWitherStorm.field_70165_t + (twod * -12.0F), this.residentWitherStorm.field_70163_u + 10.0D, this.residentWitherStorm.field_70161_v + (oned * -12.0F), 0.0F, 0.0F); 
      } 
    } 
    ...
    if (func_110143_aJ() <= 0.0F) {
      ...
      float f15 = (this.field_70146_Z.nextFloat() - 0.5F) * 12.0F;
