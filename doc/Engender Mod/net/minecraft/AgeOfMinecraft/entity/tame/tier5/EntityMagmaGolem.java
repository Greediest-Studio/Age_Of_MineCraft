...
public class EntityMagmaGolem extends EntityTameBase implements Armored, Elemental {
  ...
  public void func_70636_d() {
    ...
    if (func_70026_G()) {
      ...
      func_70097_a((new DamageSource("cooler")).func_76348_h().func_151518_m().func_76351_m(), 8.0F);
    } 
  ...
  public boolean func_70652_k(Entity entityIn) {
    ...
    AttributeModifier irongolemrandomizer = (new AttributeModifier(UUID.fromString("B9766B59-8566-4402-BC1F-3EE2A276D839"), "Iron Golem randomizer", this.field_70146_Z.nextDouble() * 0.5D, 1)).func_111168_a(false);
  ...
  public boolean func_70097_a(DamageSource source, float amount) {
    if (super.func_70097_a(source, amount)) {
      if (!source.func_82725_o() && source.func_76346_g() instanceof EntityLivingBase) {
        EntityLivingBase entitylivingbase = (EntityLivingBase)source.func_76346_g();
        if (!entitylivingbase.func_70045_F() && !source.func_94541_c() && (!entitylivingbase.func_184191_r((Entity)this) || (getOwner() != null && entitylivingbase == getOwner()))) {
          entitylivingbase.func_70097_a((new EntityDamageSource("litOnFire", (Entity)this)).func_180138_v().func_76348_h().func_76361_j(), 2.0F);
          func_184185_a(SoundEvents.field_187658_bx, func_70599_aP(), func_70647_i());
