...
public class ModelCMMCreeper extends ModelBase implements ICappedModel {
  ...
  public ModelCMMCreeper(float p_i46366_1_) {
    ...
    this.Skirt2.func_78792_a(this.Skirt1);
    this.Neck.func_78792_a(this.Head);
    this.BustFront.func_78792_a(this.BustBottom);
    this.Head.func_78792_a(this.Hood1);
    ...
    this.Abdoman.func_78792_a(this.Skirt2);
  ...
  public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    if (((EntityCreeper)entity).getPowered() && !this.field_78091_s) {
    ...
    this.RArm.field_78795_f = MathHelper.func_76134_b(limbSwing * 0.6662F * (!entity.field_70122_E ? 0.1F : 1.0F) + 3.1415927F) * 2.0F * limbSwingAmount * 0.5F;
    this.LArm.field_78795_f = MathHelper.func_76134_b(limbSwing * 0.6662F * (!entity.field_70122_E ? 0.1F : 1.0F)) * 2.0F * limbSwingAmount * 0.5F;
    this.RArm.field_78808_h = 0.0F;
    this.LArm.field_78808_h = 0.0F;
    this.RArm.field_78796_g = 0.0F;
    this.LArm.field_78796_g = 0.0F;
    this.RLeg.field_78795_f = MathHelper.func_76134_b(limbSwing * 0.6662F * (!entity.field_70122_E ? 0.1F : 1.0F)) * 1.4F * limbSwingAmount * 0.5F;
    this.LLeg.field_78795_f = MathHelper.func_76134_b(limbSwing * 0.6662F * (!entity.field_70122_E ? 0.1F : 1.0F) + 3.1415927F) * 1.4F * limbSwingAmount * 0.5F;
    ...
    this.Neck.field_78808_h += MathHelper.func_76134_b(limbSwing * 0.6662F * (!entity.field_70122_E ? 0.1F : 1.0F)) * 0.6F * limbSwingAmount * 0.5F;
    this.Body.field_78808_h -= MathHelper.func_76134_b(limbSwing * 0.6662F * (!entity.field_70122_E ? 0.1F : 1.0F)) * 0.8F * limbSwingAmount * 0.5F;
    this.Abdoman.field_78808_h += MathHelper.func_76134_b(limbSwing * 0.6662F * (!entity.field_70122_E ? 0.1F : 1.0F)) * 0.4F * limbSwingAmount * 0.5F;
    this.Abdoman.field_78798_e = MathHelper.func_76134_b(limbSwing * 0.6662F * (!entity.field_70122_E ? 0.1F : 1.0F)) * 0.5F * limbSwingAmount * 0.5F;
    this.Abdoman.field_78797_d = 12.0F + MathHelper.func_76134_b(limbSwing * 0.6662F * (!entity.field_70122_E ? 0.1F : 1.0F)) * 0.1F * limbSwingAmount * 0.5F;
    this.RArm.field_78800_c += MathHelper.func_76134_b(limbSwing * 0.6662F * (!entity.field_70122_E ? 0.1F : 1.0F)) * 1.5F * limbSwingAmount * 0.5F;
    this.LArm.field_78800_c += MathHelper.func_76134_b(limbSwing * 0.6662F * (!entity.field_70122_E ? 0.1F : 1.0F)) * 1.5F * limbSwingAmount * 0.5F;
    ...
    if (entity.isSitResting()) {
      this.Head.field_78808_h -= MathHelper.func_76134_b(ageInTicks * 0.25F) * 0.05F;
      this.Neck.field_78808_h -= MathHelper.func_76134_b(ageInTicks * 0.25F) * 0.05F;
      this.RArm.field_78795_f += -0.15707964F;
      this.LArm.field_78795_f += -0.15707964F;
      this.RLeg.field_78795_f = -1.4137167F;
      this.RLeg.field_78796_g = 0.05F - MathHelper.func_76134_b(ageInTicks * 0.325F) * 0.1F;
      this.RLeg.field_78808_h = 0.07853982F;
      this.LLeg.field_78795_f = -1.4137167F;
      this.LLeg.field_78796_g = -0.05F + MathHelper.func_76134_b(ageInTicks * 0.325F) * 0.1F;
      this.LLeg.field_78808_h = -0.07853982F;
      this.Skirt2.field_78795_f = -0.70685834F;
    } 
    ...
    if (entity.field_70725_aQ > 0) {
      ...
      if (k > 1.0F)
        k = 1.0F; 
      this.RArm.field_78808_h = k * 1.25F;
      this.LArm.field_78808_h = -k * 1.25F;
      this.RLeg.field_78808_h = k * 0.75F;
      this.LLeg.field_78808_h = -k * 0.75F;
      this.Neck.field_78796_g = -k * 0.5F;
      this.Head.field_78796_g = -k * 0.5F;
    } 
  }
}
