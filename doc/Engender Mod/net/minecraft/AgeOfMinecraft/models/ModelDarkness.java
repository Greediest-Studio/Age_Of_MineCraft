...
public class ModelDarkness extends ModelBase {
  ...
  public void func_78088_a(Entity entityIn, float p_78088_2_, float limbSwing, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    for (int j = 0; j < 2; j++) {
      ...
      this.wing.field_78795_f = 0.125F - (float)Math.cos(f11) * 0.25F;
      this.wing.field_78796_g = 0.25F;
      this.wing.field_78808_h = (float)(Math.sin(f11) + 0.125D) * 0.8F;
      this.wingTip.field_78808_h = -((float)(Math.sin((f11 + 2.0F)) + 0.5D)) * 0.75F;
      this.rearLeg.field_78795_f = 1.0F + f1 * 0.1F;
      this.rearLegTip.field_78795_f = 0.5F + f1 * 0.1F;
      this.rearFoot.field_78795_f = 0.75F + f1 * 0.1F;
      this.rearLeg.field_78808_h = 0.0F;
      this.rearLegTip.field_78808_h = 0.0F;
      this.rearFoot.field_78808_h = 0.0F;
      this.frontLeg.field_78808_h = 0.0F;
      this.frontLeg.field_78795_f = 1.3F + f1 * 0.1F;
      this.frontLegTip.field_78808_h = 0.0F;
      this.frontLegTip.field_78795_f = -0.5F - f1 * 0.1F;
      this.frontFoot.field_78795_f = 0.75F + f1 * 0.1F;
    ...
    for (int k = 0; k < 12; k++) {
      ...
      this.spine.field_78796_g = (updateRotations(adouble2[0] - adouble[0]) * f5 + 180.0F) * 0.017453292F;
