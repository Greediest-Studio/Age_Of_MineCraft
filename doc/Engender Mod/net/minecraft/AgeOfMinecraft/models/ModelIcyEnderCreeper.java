...
public class ModelIcyEnderCreeper extends ModelBiped {
  ...
  public ModelIcyEnderCreeper(float scale) {
    ...
    this.field_178720_f.func_78790_a(-4.0F, -8.0F, -4.0F, 8, 8, 8, scale - 0.1F);
  ...
  public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    this.isCarrying = (entity.func_184179_bs() != null);
    this.field_78091_s = entity.func_70631_g_();
    this.field_78117_n = entity.func_70093_af();
    this.field_178720_f.field_78800_c = 0.0F;
    if (this.isAttacking) {
      this.field_78116_c.field_78797_d -= 4.5F - MathHelper.func_76126_a(this.field_78116_c.field_78795_f);
      this.field_178720_f.field_78798_e = MathHelper.func_76126_a(this.field_78116_c.field_78795_f) * 4.5F;
    } 
