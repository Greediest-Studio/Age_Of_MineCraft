...
public class ModelCMMVillager extends ModelBase implements ICappedModel {
  ...
  public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    EntityVillager entity = (EntityVillager)entityIn;
    ...
    if (this.field_78091_s) {
      ...
      this.Skirt2.field_78807_k = true;
    } else {
      this.BustFront.field_78807_k = false;
      this.Skirt2.field_78807_k = false;
    } 
