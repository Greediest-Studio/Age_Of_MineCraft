...
public class ModelCMMZombie extends ModelZombie implements ICappedModel {
  ...
  public ModelCMMZombie() {
    ...
    this.Skirt3 = new ModelRenderer((ModelBase)this, 30, 49);
    ...
    this.Skirt2 = new ModelRenderer((ModelBase)this, 36, 38);
    this.Skirt2.func_78793_a(0.0F, 4.0F, 0.0F);
    this.Skirt2.func_78790_a(-4.0F, 0.0F, -3.0F, 8, 5, 6, 0.0F);
    this.RArm2 = new ModelRenderer((ModelBase)this, 30, 15);
  ...
  public ModelCMMZombie(float modelSize, boolean p_i46303_2_) {
    ...
    this.LArm2.func_78793_a(0.0F, 0.0F, 0.0F);
    this.LArm2.func_78790_a(-0.5F, 4.0F, -1.5F, 3, 6, 3, 0.0F);
    this.BustTop = new ModelRenderer((ModelBase)this, 20, 45);
    this.BustTop.func_78793_a(0.0F, -2.5F, -0.7F);
    this.BustTop.func_78790_a(-3.0F, 0.0F, 0.0F, 6, 2, 2, 0.0F);
    setRotateAngle(this.BustTop, -0.7853982F, 0.0F, 0.0F);
    this.BustBottom = new ModelRenderer((ModelBase)this, 20, 53);
    this.BustBottom.func_78793_a(0.0F, -0.7F, -1.0F);
    this.BustBottom.func_78790_a(-3.0F, 0.0F, 0.0F, 6, 2, 2, 0.0F);
    setRotateAngle(this.BustBottom, -0.43633232F, 0.0F, 0.0F);
    this.Abdoman = new ModelRenderer((ModelBase)this, 0, 55);
  ...
  public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    if (((EntityZombie)entity).isVillager()) {
      ...
      if (((EntityZombie)entity).isConverting()) {
        ...
        this.Head.field_78796_g += (entity.func_70681_au().nextFloat() - 0.5F) * 0.25F;
        this.RArm.field_78795_f = -1.0F;
        this.LArm.field_78795_f = -1.0F;
        this.RArm.field_78808_h = -0.5F;
        this.LArm.field_78808_h = 0.5F;
      } 
    } 
    ...
    if (this.field_78093_q && entity.func_184218_aH())
      if (this.field_78091_s && entity.func_184187_bx() instanceof net.minecraft.entity.player.EntityPlayer) {
    ...
    if (entity.getJukeboxToDanceTo() != null) {
      this.Neck.field_78808_h = MathHelper.func_76134_b(ageInTicks * 0.5F - 3.1415927F) * 0.125F;
      this.Body.field_78808_h = MathHelper.func_76134_b(ageInTicks * 0.5F - 3.1415927F) * 0.25F;
      this.Abdoman.field_78808_h = MathHelper.func_76134_b(ageInTicks * 0.5F) * 0.25F;
      this.Abdoman.field_78800_c = MathHelper.func_76134_b(ageInTicks * 0.5F - 3.1415927F) * 0.25F;
      this.Abdoman.field_78797_d = 12.0F + MathHelper.func_76134_b(ageInTicks * 1.0F) * 1.0F;
      this.RArm.field_78800_c = -3.5F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 1.5F;
      this.LArm.field_78800_c = 3.5F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 1.5F;
      this.Abdoman.field_78798_e = 0.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 6.0F;
      this.RArm.field_78798_e = 0.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 6.0F;
      this.LArm.field_78798_e = 0.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 6.0F;
      this.RLeg.field_78798_e = 0.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 6.0F;
      this.LLeg.field_78798_e = 0.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 6.0F;
      this.RArm.field_78797_d = 3.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 1.0F;
      this.LArm.field_78797_d = 3.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 1.0F;
      this.RArm.field_78795_f = -0.5F;
      this.LArm.field_78795_f = -0.5F;
      this.RArm.field_78808_h = 2.0F + MathHelper.func_76134_b(ageInTicks * 0.5F - 3.1415927F) * 0.25F - MathHelper.func_76134_b(ageInTicks * 0.25F) * 1.0F;
      this.LArm.field_78808_h = -2.0F - MathHelper.func_76134_b(ageInTicks * 0.5F - 3.1415927F) * 0.25F + MathHelper.func_76134_b(ageInTicks * 0.25F) * 1.0F;
      this.RArm.field_78796_g = 0.0F;
      this.LArm.field_78796_g = 0.0F;
      this.RLeg.field_78795_f = MathHelper.func_76134_b(ageInTicks * 0.5F) * 0.5F - MathHelper.func_76134_b(ageInTicks * 0.5F) * 1.0F;
      this.LLeg.field_78795_f = MathHelper.func_76134_b(ageInTicks * 0.5F - 3.1415927F) * 0.5F - MathHelper.func_76134_b(ageInTicks * 0.5F - 3.1415927F) * 1.0F;
    } 
    ...
    this.field_178721_j.field_78795_f = this.RLeg.field_78795_f;
    this.field_178721_j.field_78796_g = this.RLeg.field_78796_g;
    this.field_178721_j.field_78808_h = this.RLeg.field_78808_h;
