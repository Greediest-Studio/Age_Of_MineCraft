...
public class ModelCMMEvoker extends ModelBase implements ICappedModel {
  ...
  public ModelCMMEvoker() {
    ...
    this.LArm2.func_78790_a(-0.5F, 0.0F, -1.5F, 3, 10, 3, 0.0F);
    this.RArm2 = new ModelRenderer(this, 30, 14);
    this.RArm2.func_78793_a(0.0F, 0.0F, 0.0F);
    this.RArm2.func_78790_a(-2.5F, 0.0F, -1.5F, 3, 10, 3, 0.0F);
    ...
    this.HBun.func_78793_a(0.0F, 0.0F, 0.0F);
    this.HBun.func_78790_a(-2.0F, -9.0F, 0.5F, 4, 4, 4, 0.0F);
    ...
    this.Head.func_78792_a(this.HBun);
  }
  ...
  public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    if (((EntityEvoker)entity).isSpellcasting()) {
      ...
      this.RArm.field_78795_f = MathHelper.func_76134_b(ageInTicks * 0.6662F) * 0.25F;
      this.LArm.field_78795_f = MathHelper.func_76134_b(ageInTicks * 0.6662F) * 0.25F;
      this.RArm.field_78795_f -= f * 2.5F - f1 * 0.5F;
      this.LArm.field_78795_f -= f * 2.5F - f1 * 0.5F;
    ...
    if (entity.getJukeboxToDanceTo() != null) {
      this.Skirt1.field_78808_h = -(MathHelper.func_76134_b(ageInTicks * 0.5F) * 0.15F);
      this.Skirt2.field_78808_h = -(MathHelper.func_76134_b(ageInTicks * 0.5F) * 0.125F);
      this.Skirt3.field_78808_h = -(MathHelper.func_76134_b(ageInTicks * 0.5F) * 0.125F);
      ...
      this.RArm.field_78797_d = 4.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 0.5F;
      this.LArm.field_78797_d = 4.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 0.5F;
      this.Abdoman.field_78798_e = 0.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 3.0F;
      this.RArm.field_78798_e = 0.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 3.0F;
      this.LArm.field_78798_e = 0.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 3.0F;
      this.RLeg.field_78798_e = 0.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 3.0F;
      this.LLeg.field_78798_e = 0.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 3.0F;
      this.RArm.field_78797_d = 3.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 0.5F;
      this.LArm.field_78797_d = 3.0F + MathHelper.func_76134_b(ageInTicks * 0.5F) * 0.5F;
      this.RArm.field_78795_f = MathHelper.func_76134_b(ageInTicks * 0.6662F) * 0.5F;
      this.LArm.field_78795_f = MathHelper.func_76134_b(ageInTicks * 0.6662F) * 0.5F;
      this.RArm.field_78808_h = 2.3561945F;
      this.LArm.field_78808_h = -2.3561945F;
