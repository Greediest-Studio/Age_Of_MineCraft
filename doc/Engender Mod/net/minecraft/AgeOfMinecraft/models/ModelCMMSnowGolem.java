...
public class ModelCMMSnowGolem extends ModelBase implements ICappedModel {
  ...
  public ModelCMMSnowGolem() {
    this.bipedCape = new ModelRenderer(this, 0, 0);
    this.bipedCape.func_78787_b(64, 32);
    this.bipedCape.func_78790_a(-5.0F, 0.0F, -1.0F, 10, 16, 1, 0.0F);
    this.field_78090_t = 64;
    this.field_78089_u = 64;
    this.Skirt3 = new ModelRenderer(this, 34, 53);
    this.Skirt3.func_78793_a(0.0F, 4.0F, 0.0F);
    this.Skirt3.func_78790_a(-4.5F, 0.0F, -3.0F, 9, 5, 6, 0.0F);
    ...
    this.Hat = new ModelRenderer(this, 0, 28);
    this.Hat.func_78793_a(0.0F, 0.0F, 0.0F);
    this.Hat.func_78790_a(-4.0F, -11.0F, -3.5F, 8, 5, 7, 0.0F);
    this.HNeck = new ModelRenderer(this, 0, 40);
    this.HNeck.func_78793_a(0.0F, -5.0F, 0.0F);
    this.HNeck.func_78790_a(-3.5F, -1.0F, -2.5F, 7, 1, 5, 0.0F);
    ...
    this.Hair.func_78790_a(-4.0F, -6.0F, -3.5F, 8, 9, 7, 0.0F);
    ...
    this.LArm2.func_78790_a(-0.5F, 3.0F, -1.5F, 3, 7, 3, 0.0F);
    this.RArm2 = new ModelRenderer(this, 30, 14);
    this.RArm2.func_78793_a(0.0F, 0.0F, 0.0F);
    this.RArm2.func_78790_a(-2.5F, 3.0F, -1.5F, 3, 7, 3, 0.0F);
    this.Head = new ModelRenderer(this, 0, 0);
    this.Head.func_78793_a(0.0F, -1.0F, 0.0F);
    this.Head.func_78790_a(-3.5F, -6.0F, -3.0F, 7, 6, 6, 0.0F);
    this.HTop = new ModelRenderer(this, 0, 0);
    this.HTop.func_78793_a(0.0F, -1.0F, 0.0F);
    this.HTop.func_78790_a(-3.5F, -6.0F, -3.0F, 7, 2, 6, -0.25F);
    ...
    this.Skirt2 = new ModelRenderer(this, 38, 44);
  ...
  public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    EntitySnowman entity = (EntitySnowman)entityIn;
    ...
    if (!entity.isPumpkinEquipped()) {
      this.Hat.field_78807_k = false;
    } else {
      this.Hat.field_78807_k = true;
    } 
    ...
    this.Head.field_78808_h += MathHelper.func_76134_b(limbSwing * 0.6662F * (!entity.field_70122_E ? 0.1F : 1.0F)) * 0.6F * limbSwingAmount * 0.5F;
    ...
    if (this.isSneak && !entity.isSitResting() && entity.field_70122_E && entity.getJukeboxToDanceTo() == null) {
      ...
      this.Skirt2.field_78795_f -= 0.3F;
      this.Skirt3.field_78795_f -= 0.3F;
    } 
    ...
    if (entity.isSitResting()) {
      this.Head.field_78808_h -= MathHelper.func_76134_b(ageInTicks * 0.25F) * 0.1F;
      ...
      this.LLeg.field_78808_h = -0.07853982F;
      this.Skirt1.field_78795_f = -0.53333336F;
      this.Skirt2.field_78795_f = -0.4333333F;
      this.Skirt3.field_78795_f = -0.4333333F;
    } 
    ...
    if (this.field_78095_p > 0.0F) {
      ...
      float f3 = MathHelper.func_76126_a(this.field_78095_p * 3.1415927F) * -(this.Head.field_78795_f - 0.7F) * 0.75F;
