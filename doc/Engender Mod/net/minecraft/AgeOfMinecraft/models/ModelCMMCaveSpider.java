...
public class ModelCMMCaveSpider extends ModelBiped implements ICappedModel {
  ...
  public void renderCape(float scale, float flo1, float flo2, float flo3) {
    ...
    GlStateManager.func_179109_b(0.0F, this.field_78117_n ? 0.25F : 0.125F, this.field_78117_n ? -0.625F : -0.0325F);
  ...
  public ModelCMMCaveSpider() {
    ...
    this.HRight2.func_78793_a(-2.0F, 0.0F, 0.0F);
    this.HRight2.func_78790_a(-1.0F, -1.0F, -1.0F, 2, 2, 2, 0.0F);
    this.HLeft = new ModelRenderer((ModelBase)this, 42, 31);
    this.HLeft.func_78793_a(3.0F, -3.5F, 0.0F);
    this.HLeft.func_78790_a(-0.1F, -2.5F, -2.0F, 2, 5, 4, 0.0F);
    this.RArm = new ModelRenderer((ModelBase)this, 36, 0);
    this.RArm.func_78793_a(-3.5F, 3.0F, 0.0F);
    this.RArm.func_78790_a(-2.0F, -1.0F, -1.0F, 2, 10, 2, 0.0F);
    this.LArm = new ModelRenderer((ModelBase)this, 44, 0);
    this.LArm.func_78793_a(3.5F, 3.0F, 0.0F);
    this.LArm.func_78790_a(0.0F, -1.0F, -1.0F, 2, 10, 2, 0.0F);
    this.Hair = new ModelRenderer((ModelBase)this, 0, 31);
    this.Hair.func_78793_a(0.0F, 0.0F, 0.0F);
    this.Hair.func_78790_a(-4.0F, -7.1F, -3.5F, 8, 7, 7, 0.0F);
    ...
    this.Skirt.func_78790_a(-4.0F, 0.0F, -2.5F, 8, 2, 5, 0.0F);
    this.HLeft2 = new ModelRenderer((ModelBase)this, 38, 40);
    this.HLeft2.func_78793_a(0.0F, -0.5F, 0.0F);
    this.HLeft2.func_78790_a(1.0F, -1.0F, -1.0F, 2, 2, 2, 0.0F);
    this.HRight = new ModelRenderer((ModelBase)this, 30, 31);
    this.HRight.func_78793_a(-3.0F, -3.5F, 0.0F);
    this.HRight.func_78790_a(-1.9F, -2.5F, -2.0F, 2, 5, 4, 0.0F);
    this.Skirt2 = new ModelRenderer((ModelBase)this, 20, 18);
    this.Skirt2.func_78793_a(0.0F, -1.0F, 0.0F);
    this.Skirt2.func_78790_a(-3.5F, 0.0F, -2.0F, 7, 2, 4, 0.0F);
    ...
    this.HRight3.func_78793_a(0.0F, 0.0F, 0.0F);
    this.HRight3.func_78790_a(-5.0F, -6.9F, -2.5F, 1, 2, 1, 0.0F);
    this.HLeft3 = new ModelRenderer((ModelBase)this, 26, 0);
    this.HLeft3.func_78793_a(0.0F, 0.0F, 0.0F);
    this.HLeft3.func_78790_a(4.0F, -6.9F, -2.5F, 1, 2, 1, 0.0F);
    ...
    this.HTop.func_78790_a(-3.0F, -8.0F, -3.0F, 6, 1, 6, 0.0F);
    this.Neck.func_78792_a(this.Head);
    this.HRight.func_78792_a(this.HRight2);
    this.Head.func_78792_a(this.HLeft);
    this.Head.func_78792_a(this.Hair);
    this.Skirt2.func_78792_a(this.Skirt);
    this.HLeft.func_78792_a(this.HLeft2);
    this.Head.func_78792_a(this.HRight);
    this.Abdoman.func_78792_a(this.Skirt2);
    this.Head.func_78792_a(this.HRight3);
    this.Head.func_78792_a(this.HLeft3);
