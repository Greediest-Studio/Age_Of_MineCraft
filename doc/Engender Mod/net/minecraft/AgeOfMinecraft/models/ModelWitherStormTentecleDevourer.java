...
public class ModelWitherStormTentecleDevourer extends ModelBase {
  ...
  public ModelWitherStormTentecleDevourer() {
    ...
    this.TentecleTip3.func_78790_a(-6.0F, -128.0F, -6.0F, 12, 128, 12, 0.0F);
  ...
  public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    this.TentecleBase1.field_78796_g = 0.4F * MathHelper.func_76126_a(ageInTicks * 0.031200068F + 3.9F);
    this.TentecleBase2.field_78795_f = 0.4F;
    this.TentecleBase3.field_78795_f = -0.1F;
    this.TentecleBase4.field_78795_f = -0.1F;
    this.TentecleMiddle1.field_78795_f = -0.1F;
    this.TentecleMiddle2.field_78795_f = -0.1F;
    this.TentecleMiddle3.field_78795_f = -0.1F;
    this.TentecleTip1.field_78795_f = -0.1F;
    this.TentecleTip2.field_78795_f = -0.1F;
    this.TentecleTip3.field_78795_f = -0.1F;
    this.TentecleBase1.field_78808_h = 0.5F * MathHelper.func_76126_a(ageInTicks * 0.02F + 3.9F);
    this.TentecleBase2.field_78808_h = 0.5F * MathHelper.func_76126_a(ageInTicks * 0.02F + 3.6F);
    this.TentecleBase3.field_78808_h = 0.25F * MathHelper.func_76126_a(ageInTicks * 0.02F + 3.3F);
    this.TentecleBase4.field_78808_h = 0.2F * MathHelper.func_76126_a(ageInTicks * 0.02F + 3.0F);
    this.TentecleMiddle1.field_78808_h = 0.15F * MathHelper.func_76126_a(ageInTicks * 0.02F + 2.8F);
    this.TentecleMiddle2.field_78808_h = 0.15F * MathHelper.func_76126_a(ageInTicks * 0.02F + 2.4F);
    this.TentecleMiddle3.field_78808_h = 0.15F * MathHelper.func_76126_a(ageInTicks * 0.02F + 2.0F);
    this.TentecleTip1.field_78808_h = 0.1F * MathHelper.func_76126_a(ageInTicks * 0.02F + 1.8F);
    this.TentecleTip2.field_78808_h = 0.1F * MathHelper.func_76126_a(ageInTicks * 0.02F + 1.4F);
    this.TentecleTip3.field_78808_h = 0.2F * MathHelper.func_76126_a(ageInTicks * 0.02F + 1.0F);
    this.TentecleBase1.field_78795_f = 0.3F * MathHelper.func_76126_a(ageInTicks * 0.05F + 1.0F);
