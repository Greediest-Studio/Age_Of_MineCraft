...
public class CommonProxy implements IGuiHandler {
    ...
    switch (ID) {
      case 101:
        if (entity != null && entity instanceof TileEntityMonsterSpawnerSPC)
          return new ContainerMobSpawner(player.field_71071_by, (IInventory)entity); 
        break;
    } 
    return null;
  }
  ...
  public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
    ...
    switch (ID) {
      case 100:
        if (!stack.func_190926_b() && stack.func_77973_b() instanceof ItemEngenderStatChecker)
          return new GuiEngenderMobInventory(player, ItemEngenderStatChecker.viewedEntity); 
      case 101:
        if (entity != null && entity instanceof TileEntityMonsterSpawnerSPC)
          return new GuiEngenderFusionCrafter(player.field_71071_by, (IInventory)entity); 
        break;
    } 
    return null;
  }
