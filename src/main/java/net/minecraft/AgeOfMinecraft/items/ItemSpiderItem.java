...
public class ItemSpiderItem extends ItemVanillaTier {
  public ItemSpiderItem() {
    super(2, 18, 32, "spider");
  }
  ...
  public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    net.minecraft.AgeOfMinecraft.util.EntityCompat.setEntityState(entityliving, (byte)30);
    if (!net.minecraft.AgeOfMinecraft.util.EntityCompat.isRemote(worldIn)) {
