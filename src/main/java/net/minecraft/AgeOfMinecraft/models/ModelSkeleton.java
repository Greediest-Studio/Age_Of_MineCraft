...
public class ModelSkeleton extends ModelBiped implements ICappedModel {
  ...
  public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
    ...
    if (itemstack != null && itemstack.getItem() instanceof net.minecraft.item.ItemBow && ((EntityTameBase)entitylivingbaseIn).isArmsRaised())
  ...
  public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    if (entity.isArmsRaised() && (itemstack == null || (itemstack != null && !(itemstack.getItem() instanceof net.minecraft.item.ItemBow)))) {
    ...
    if (entity.getJukeboxToDanceTo() != null) {
      ...
      this.bipedRightArm.rotateAngleZ = 1.6561944F - MathHelper.cos(ageInTicks * 0.25F) * 1.0F;
      this.bipedLeftArm.rotateAngleZ = -0.9561945F + MathHelper.cos(ageInTicks * 0.25F) * 1.0F;
      this.bipedRightArm.rotateAngleY = 0.0F;
      this.bipedLeftArm.rotateAngleY = 0.0F;
      this.bipedHead.setRotationPoint(0.0F + MathHelper.cos(ageInTicks * 0.25F) * 1.0F, 0.5F - fl, 0.0F);
    } 
