...
public class ModelCMMVindicator extends ModelBase implements ICappedModel {
  ...
  public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    if (entity.isAggressive()) {
      ...
      this.RArm.rotateAngleZ = 0.0F;
      this.LArm.rotateAngleZ = 0.0F;
      this.RArm.rotateAngleY = 0.15707964F;
      this.LArm.rotateAngleY = -0.15707964F;
      if (((EntityLivingBase)entityIn).getPrimaryHand() == EnumHandSide.RIGHT) {
        this.RArm.rotateAngleX = -1.8849558F + MathHelper.cos(ageInTicks * 0.09F) * 0.15F;
        this.LArm.rotateAngleX = -0.0F + MathHelper.cos(ageInTicks * 0.19F) * 0.5F;
        this.RArm.rotateAngleX += f * 2.2F - f1 * 0.4F;
        this.LArm.rotateAngleX += f * 1.2F - f1 * 0.4F;
      } else {
        this.RArm.rotateAngleX = -0.0F + MathHelper.cos(ageInTicks * 0.19F) * 0.5F;
        this.LArm.rotateAngleX = -1.8849558F + MathHelper.cos(ageInTicks * 0.09F) * 0.15F;
        this.RArm.rotateAngleX += f * 1.2F - f1 * 0.4F;
        this.LArm.rotateAngleX += f * 2.2F - f1 * 0.4F;
      } 
    } 
    ...
    if (entity.getJukeboxToDanceTo() != null) {
      ...
      this.RArm.rotateAngleX = -2.0F - MathHelper.cos(ageInTicks * 1.0F - 3.1415927F) * 0.25F;
      this.LArm.rotateAngleX = -2.0F - MathHelper.cos(ageInTicks * 1.0F) * 0.25F;
      this.RArm.rotateAngleZ = 2.0F;
      this.LArm.rotateAngleZ = -2.0F;
      this.RArm.rotateAngleY = MathHelper.sin(ageInTicks * 1.0F - 3.1415927F) * 0.25F;
      this.LArm.rotateAngleY = MathHelper.sin(ageInTicks * 1.0F) * 0.25F;
