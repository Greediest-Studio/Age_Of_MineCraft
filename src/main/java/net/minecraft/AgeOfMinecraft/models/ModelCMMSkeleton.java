...
public class ModelCMMSkeleton extends ModelSkeleton implements ICappedModel {
  ...
  public ModelCMMSkeleton() {
    ...
    this.BHair1 = new ModelRenderer(this, 0, 36);
    ...
    this.LPointyTair1 = new ModelRenderer(this, 24, 36);
    ...
    this.RPointyTair3 = new ModelRenderer(this, 24, 42);
    ...
    this.LPointyTair2 = new ModelRenderer(this, 24, 39);
    ...
    this.BHair4 = new ModelRenderer(this, 0, 43);
