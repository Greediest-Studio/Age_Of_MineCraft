...
public class ModelDarkness extends ModelBase {
  ...
  public void render(Entity entityIn, float p_78088_2_, float limbSwing, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    for (int j = 0; j < 2; j++) {
      ...
      this.wing.rotateAngleX = 0.125F - (float)Math.cos(f11) * 0.25F;
      ...
      this.rearLeg.rotateAngleZ = 0.0F;
      this.rearLegTip.rotateAngleZ = 0.0F;
      this.rearFoot.rotateAngleZ = 0.0F;
      this.frontLeg.rotateAngleZ = 0.0F;
      this.frontLeg.rotateAngleX = 1.3F + f1 * 0.1F;
      this.frontLegTip.rotateAngleZ = 0.0F;
