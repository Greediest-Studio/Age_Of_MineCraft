...
public class ModelCMMWitch extends ModelBase implements ICappedModel {
  ...
  public ModelCMMWitch() {
    ...
    this.RArm.addBox(-2.0F, -1.0F, -1.0F, 2, 4, 2, 0.0F);
    ...
    this.Hat4.setRotationPoint(0.0F, -5.0F, 0.0F);
    this.Hat4.addBox(-2.0F, -1.5F, 0.0F, 4, 3, 7, 0.0F);
    ...
    this.Hat1.addBox(-7.0F, -1.0F, -6.0F, 14, 1, 12, 0.0F);
    this.Hat2 = new ModelRenderer(this, 64, 13);
    this.Hat2.setRotationPoint(0.0F, -1.0F, 0.0F);
    this.Hat2.addBox(-4.0F, -5.0F, -3.5F, 8, 5, 7, 0.0F);
    ...
    this.RArm2.addBox(-2.5F, 3.0F, -1.5F, 3, 8, 3, 0.0F);
    ...
    this.Hair.addBox(-4.0F, -6.0F, -3.5F, 8, 10, 7, 0.0F);
    this.Head = new ModelRenderer(this, 0, 0);
    this.Head.setRotationPoint(0.0F, -1.0F, 0.0F);
    this.Head.addBox(-3.5F, -6.0F, -3.0F, 7, 6, 6, 0.0F);
    this.Hat3 = new ModelRenderer(this, 64, 25);
    this.Hat3.setRotationPoint(0.0F, -3.0F, 0.0F);
    this.Hat3.addBox(-3.0F, -5.0F, -3.0F, 6, 5, 6, 0.0F);
  ...
  public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    this.Hat3.rotateAngleX = -0.175F;
    this.Hat4.rotateAngleX = -0.175F;
    ...
    if (!entity.onGround) {
      this.Hat3.rotateAngleX = (float)(this.Hat3.rotateAngleX + (MathHelper.cos(ageInTicks * 0.3F - 0.5F) * 0.1F) - ((entity.motionY > 4.0D) ? 1.0D : ((entity.motionY < -4.0D) ? 0.0D : (entity.motionY / 4.0D))));
      this.Hat4.rotateAngleX = (float)(this.Hat4.rotateAngleX + (MathHelper.cos(ageInTicks * 0.3F - 1.0F) * 0.1F) - ((entity.motionY > 4.0D) ? 1.0D : ((entity.motionY < -4.0D) ? 0.0D : (entity.motionY / 4.0D))));
      ...
      if (!entity.isBeingRidden() && !this.isRiding) {
        ...
        this.Skirt1.rotateAngleX = (float)(this.Skirt1.rotateAngleX - ((entity.motionY > 3.0D) ? 1.0D : ((entity.motionY < -3.0D) ? -1.0D : (entity.motionY / 3.0D))));
    ...
    if (entity.getJukeboxToDanceTo() != null) {
      ...
      this.RArm.rotateAngleY = 0.0F;
      this.LArm.rotateAngleY = 0.0F;
      this.RLeg.rotateAngleZ = 1.0F + MathHelper.cos(ageInTicks * 0.5F) * 0.5F;
    ...
    if (!entity.getHeldItemMainhand().isEmpty()) {
      this.RArm.rotateAngleX = -2.0F;
      this.LArm.rotateAngleX = -2.0F;
      this.RArm.rotateAngleY = -0.25F;
      this.LArm.rotateAngleY = 0.25F;
      this.RArm.rotateAngleZ = 0.0F;
      this.LArm.rotateAngleZ = 0.0F;
      ...
      this.BHair1.rotateAngleX += 0.6F;
      this.RArm.rotateAngleX += MathHelper.sin(ageInTicks * 2.0F) * 0.05F;
      this.LArm.rotateAngleX += MathHelper.sin(ageInTicks * 2.0F) * 0.05F;
      this.Head.rotateAngleX += MathHelper.sin(ageInTicks * 2.0F) * 0.05F;
      this.BHair1.rotateAngleX -= MathHelper.sin(ageInTicks * 2.0F) * 0.05F;
    } 
