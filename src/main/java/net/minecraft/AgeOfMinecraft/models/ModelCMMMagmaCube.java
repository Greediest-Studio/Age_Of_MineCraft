...
public class ModelCMMMagmaCube extends ModelBase implements ICappedModel {
  ...
  public ModelCMMMagmaCube() {
    ...
    this.Hat.addBox(-4.0F, -10.0F, -3.5F, 8, 4, 7, 0.0F);
  ...
  public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    if (!entity.getCurrentBook().isEmpty()) {
      this.RArm.rotateAngleY = entity.bookSpread - 1.0F;
      this.LArm.rotateAngleY = -entity.bookSpread + 1.0F;
      this.RArm.rotateAngleZ = 0.0F;
      this.LArm.rotateAngleZ = 0.0F;
