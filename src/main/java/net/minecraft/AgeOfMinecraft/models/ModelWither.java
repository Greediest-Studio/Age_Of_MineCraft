...
public class ModelWither extends ModelBase implements ICappedModel {
  ...
  public void renderCape(float scale, float flo1, float flo2, float flo3) {
    ...
    GlStateManager.rotate(6.0F + flo2 / 2.0F + flo1 + (this.upperBodyParts[1]).rotateAngleX * 50.0F, 1.0F, 0.0F, 0.0F);
  ...
  public void setRotationAngles(float limbSwing, float limbSwingAmount, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
    ...
    (this.heads[0]).rotationPointX = 0.0F;
    (this.heads[0]).rotationPointY = 4.0F;
    (this.heads[0]).rotateAngleZ = 0.0F;
    (this.heads[1]).rotateAngleZ = 0.0F;
    (this.heads[2]).rotateAngleZ = 0.0F;
    (this.upperBodyParts[1]).rotateAngleX = 0.0F;
    (this.upperBodyParts[2]).rotateAngleX = 0.0F;
    (this.upperBodyParts[1]).rotateAngleZ = 0.0F;
    (this.upperBodyParts[2]).rotateAngleZ = 0.0F;
    if (wither.getJukeboxToDanceTo() != null) {
      float f4 = MathHelper.sin(p_78087_3_ * 0.125F) * 0.7F;
      (this.heads[0]).rotationPointX += MathHelper.cos(p_78087_3_ * 0.25F) * 1.0F;
      (this.heads[0]).rotationPointY += f4 + MathHelper.cos(p_78087_3_ * 0.5F) * 1.0F;
      (this.heads[0]).rotateAngleX += MathHelper.cos(p_78087_3_ * 0.5F) * 0.5F;
      (this.heads[0]).rotateAngleZ += MathHelper.cos(p_78087_3_ * 0.25F) * 0.5F;
      (this.heads[1]).rotateAngleZ += MathHelper.cos(p_78087_3_ * 0.25F - 2.0F) * 0.5F;
      (this.heads[2]).rotateAngleZ -= MathHelper.cos(p_78087_3_ * 0.25F - 2.0F) * 0.5F;
      (this.upperBodyParts[1]).rotateAngleX += MathHelper.cos(p_78087_3_ * 0.25F) * 0.5F;
      (this.upperBodyParts[2]).rotateAngleX += MathHelper.cos(p_78087_3_ * 0.25F - 1.0F) * 0.5F;
    } 
    if (wither.isSneaking()) {
      ...
      (this.upperBodyParts[1]).rotateAngleX -= f2 * 2.0F - f1;
      (this.upperBodyParts[2]).rotateAngleX -= f2 * 4.0F - f1;
    } else {
  ...
  public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_) {
    ...
    for (int i = 1; i < 3; i++) {
      (this.heads[i]).rotateAngleY = (entitywither.getHeadYRotation(i - 1) - p_78086_1_.renderYawOffset) * 0.017453292F + (!entitywither.getCurrentBook().isEmpty() ? -(MathHelper.sin(entitywither.ticksExisted * 0.1F) * 0.5F + ((i == 1) ? 0.5F : -0.5F)) : 0.0F);
