...
public class ModelCMMSnowGolem extends ModelBase implements ICappedModel {
  ...
  public ModelCMMSnowGolem() {
    ...
    this.Skirt3.setRotationPoint(0.0F, 4.0F, 0.0F);
    this.Skirt3.addBox(-4.5F, 0.0F, -3.0F, 9, 5, 6, 0.0F);
    ...
    this.Hat.addBox(-4.0F, -11.0F, -3.5F, 8, 5, 7, 0.0F);
    this.HNeck = new ModelRenderer(this, 0, 40);
    this.HNeck.setRotationPoint(0.0F, -5.0F, 0.0F);
    this.HNeck.addBox(-3.5F, -1.0F, -2.5F, 7, 1, 5, 0.0F);
    ...
    this.Hair.addBox(-4.0F, -6.0F, -3.5F, 8, 9, 7, 0.0F);
    ...
    this.LArm2.addBox(-0.5F, 3.0F, -1.5F, 3, 7, 3, 0.0F);
    this.RArm2 = new ModelRenderer(this, 30, 14);
    this.RArm2.setRotationPoint(0.0F, 0.0F, 0.0F);
    this.RArm2.addBox(-2.5F, 3.0F, -1.5F, 3, 7, 3, 0.0F);
    ...
    this.HTop.addBox(-3.5F, -6.0F, -3.0F, 7, 2, 6, -0.25F);
  ...
  public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    if (!entity.isPumpkinEquipped()) {
      this.Hat.isHidden = false;
    } else {
      this.Hat.isHidden = true;
    } 
    ...
    this.Head.rotateAngleZ += MathHelper.cos(limbSwing * 0.6662F * (!entity.onGround ? 0.1F : 1.0F)) * 0.6F * limbSwingAmount * 0.5F;
    ...
    if (entity.isSitResting()) {
      this.Head.rotateAngleZ -= MathHelper.cos(ageInTicks * 0.25F) * 0.1F;
      ...
      this.LLeg.rotateAngleZ = -0.07853982F;
      this.Skirt1.rotateAngleX = -0.53333336F;
      this.Skirt2.rotateAngleX = -0.4333333F;
      this.Skirt3.rotateAngleX = -0.4333333F;
    } 
