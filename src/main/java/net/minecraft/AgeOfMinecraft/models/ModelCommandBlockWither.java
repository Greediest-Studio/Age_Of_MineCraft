...
public class ModelCommandBlockWither extends ModelBase {
  ...
  public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
    ...
    this.MainHead.rotateAngleZ = 0.0F;
    this.LeftHead.rotateAngleZ = 0.0F;
    this.RightHead.rotateAngleZ = 0.0F;
    this.spine.rotateAngleX = 0.0F;
    this.lowerspine.rotateAngleX = 0.0F;
    this.spine.rotateAngleZ = 0.0F;
    this.lowerspine.rotateAngleZ = 0.0F;
    if (wither.getJukeboxToDanceTo() != null) {
      this.MainHead.rotateAngleX += MathHelper.cos(p_78087_3_ * 1.0F) * 0.5F;
      this.MainHead.rotateAngleZ += MathHelper.cos(p_78087_3_ * 0.5F) * 0.5F;
      this.LeftHead.rotateAngleZ += MathHelper.cos(p_78087_3_ * 0.5F - 2.0F) * 0.5F;
      this.RightHead.rotateAngleZ -= MathHelper.cos(p_78087_3_ * 0.5F - 2.0F) * 0.5F;
      this.spine.rotateAngleX += MathHelper.cos(p_78087_3_ * 0.5F) * 0.5F;
      this.lowerspine.rotateAngleX += MathHelper.cos(p_78087_3_ * 0.5F + 1.0F) * 0.5F;
      this.spine.rotateAngleZ += MathHelper.cos(p_78087_3_ * 0.25F) * 0.5F;
      this.lowerspine.rotateAngleZ += MathHelper.cos(p_78087_3_ * 0.25F + 1.0F) * 0.5F;
    } 
