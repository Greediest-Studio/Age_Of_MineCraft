...
public class ModelWitherStormHead extends ModelBase {
  ...
  public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
    ...
    this.BackMouth.rotateAngleZ = 0.0F;
    EntityWitherStormHead wither = (EntityWitherStormHead)p_78087_7_;
    if (wither.getJukeboxToDanceTo() != null) {
      this.BackMouth.rotateAngleX += MathHelper.cos(p_78087_3_ * 0.5F) * 0.5F;
      this.BackMouth.rotateAngleZ += MathHelper.cos(p_78087_3_ * 0.25F) * 0.5F;
    } 
  }
