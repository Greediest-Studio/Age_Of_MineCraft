...
public class ModelZombie extends ModelBiped implements ICappedModel {
  ...
  public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    this.bipedHeadwear.isHidden = (!EngenderConfig.mobs.useMobTalkerModels && entity instanceof EntityPigZombie && ((EntityPigZombie)entity).isOldPEPigman());
    ...
    if (entity.getJukeboxToDanceTo() != null) {
      ...
      this.bipedRightArm.rotateAngleZ = 1.6561944F - MathHelper.cos(ageInTicks * 0.125F) * 1.0F;
      this.bipedLeftArm.rotateAngleZ = -1.6561944F + MathHelper.cos(ageInTicks * 0.125F) * 1.0F;
      this.bipedRightArm.rotateAngleY = 0.0F;
      this.bipedLeftArm.rotateAngleY = 0.0F;
