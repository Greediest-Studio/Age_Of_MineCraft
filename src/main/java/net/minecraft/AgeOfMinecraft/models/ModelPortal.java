...
public class ModelPortal extends ModelBase {
  ...
  public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    if (entity.deathTime > 0) {
      ...
      this.Spike1.rotateAngleX = 1.6F - ageInTicks / 30.0F;
      this.Spike2.rotateAngleX = 1.6F - ageInTicks / 30.0F;
      this.Spike3.rotateAngleX = 1.6F - ageInTicks / 30.0F;
      this.Spike4.rotateAngleX = 1.6F - ageInTicks / 30.0F;
    } else {
