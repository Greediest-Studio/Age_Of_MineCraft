...
public class ModelPrisonSpider extends ModelBase {
  ...
  public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
    ...
    if (entityskeleton.getJukeboxToDanceTo() != null) {
      ...
      this.spiderHead.setRotationPoint(0.0F + MathHelper.cos(ageInTicks * 0.25F) * 1.0F, 15.0F - fl - MathHelper.cos(ageInTicks * 0.5F) * 1.0F, -3.0F);
    } 
  }
}
