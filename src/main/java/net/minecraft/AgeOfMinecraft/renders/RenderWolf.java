...
public class RenderWolf extends RenderLiving<EntityWolf> {
  ...
  public RenderWolf(RenderManager p_i46128_1_) {
    ...
    RenderLayerCompat.addLayer(this, new LayerCustomHeadEngender(((ModelWolf)RenderLayerCompat.getMainModel(this)).wolfHeadMain, ((ModelWolf)RenderLayerCompat.getMainModel(this)).wolfHeadMain));
