...
public class LayerEndermanEyes implements LayerRenderer<EntityLivingBase> {
  ...
  public void func_177201_a(EntityEnderman p_177201_1_, float p_177201_2_, float p_177201_3_, float p_177201_4_, float p_177201_5_, float p_177201_6_, float p_177201_7_, float p_177201_8_) {
    if (p_177201_1_.isEntityAlive()) {
      this.endermanRenderer.bindTexture(p_177201_1_.canDodgeAllAttacks() ? new ResourceLocation("textures/entity/enderdragon/dragon_exploding.png") : (EngenderConfig.mobs.useMobTalkerModels ? (p_177201_1_.isAntiMob() ? antiRES_CMM_ENDERMAN_EYES : RES_CMM_ENDERMAN_EYES) : (p_177201_1_.isAntiMob() ? antiRES_ENDERMAN_EYES : RES_ENDERMAN_EYES)));
      ...
      if (p_177201_1_.canDodgeAllAttacks()) {
        ...
        float f8 = MathHelper.cos(f7 * 0.2F);
        float f9 = f7 * 0.01F;
