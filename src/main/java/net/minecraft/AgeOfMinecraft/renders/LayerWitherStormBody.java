...
public class LayerWitherStormBody implements LayerRenderer<EntityLivingBase> {
  ...
  public void func_177214_a(EntityWitherStorm p_177214_1_, float p_177214_2_, float p_177214_3_, float p_177214_4_, float p_177214_5_, float p_177214_6_, float p_177214_7_, float p_177214_8_) {
    if (p_177214_1_.doesntContainACommandBlock()) {
      ...
      GlStateManager.translate(0.0F, -12.0F - p_177214_1_.getMaxHealth() * 5.0E-7F, 0.0F + p_177214_1_.getMaxHealth() * 6.25E-7F);
      if (p_177214_1_.getSize() > 50000)
        GlStateManager.translate(0.0F, 4.0F + p_177214_1_.getMaxHealth() * 5.0E-7F, 0.5F + p_177214_1_.getMaxHealth() * 1.0E-5F); 
      if (p_177214_1_.getSize() > 250000)
        GlStateManager.translate(0.0F, 2.0F - p_177214_1_.getMaxHealth() * 1.0E-7F, 1.0F - p_177214_1_.getMaxHealth() * 1.0E-5F); 
      GlStateManager.rotate(p_177214_1_.isSneaking() ? -60.0F : -20.0F, 1.0F, 0.0F, 0.0F);
