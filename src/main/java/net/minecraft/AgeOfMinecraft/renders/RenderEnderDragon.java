...
public class RenderEnderDragon extends RenderLiving<EntityEnderDragon> {
  ...
  public RenderEnderDragon(RenderManager renderManagerIn) {
    ...
    this.modelDragon = (ModelEnderDragon)RenderLayerCompat.getMainModel(this);
    RenderLayerCompat.addLayer(this, new LayerEnderDragonEyes(this));
    RenderLayerCompat.addLayer(this, new LayerEnderDragonDeath());
  ...
  public void doRender(EntityEnderDragon entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    if (entity.isCarryingCrystal()) {
      ...
      float fl1 = (entity.getJukeboxToDanceTo() != null) ? (MathHelper.sin(f * 0.1F) * 10.0F) : ((float)entity.motionX * 10.0F);
      float fl2 = (entity.getJukeboxToDanceTo() != null) ? (MathHelper.sin(f * 0.3F) * 5.0F) : ((float)entity.motionY * 5.0F);
      float fl3 = (entity.getJukeboxToDanceTo() != null) ? (MathHelper.cos(f * 0.1F) * 10.0F) : ((float)entity.motionZ * 10.0F);
      ...
      float f3 = (float)entity.posY - 10.0F + fl2;
      float f4 = (float)entity.posZ + fl3;
      double d0 = f2 - entity.posX + fl1;
      double d1 = f3 - entity.posY - 10.0D + fl2;
      double d2 = f4 - entity.posZ + fl3;
      if (entity.getHealth() < entity.getMaxHealth())
        renderCrystalBeams(x + d0, y - 0.3D + (f1 * 0.4F) + d1, z + d2, partialTicks, f2, f3, f4, entity.innerRotation, entity.posX, entity.posY, entity.posZ); 
    } 
  }
