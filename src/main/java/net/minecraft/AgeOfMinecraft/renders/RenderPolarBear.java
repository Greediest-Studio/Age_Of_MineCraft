...
public class RenderPolarBear extends RenderLiving<EntityPolarBear> {
  ...
  public RenderPolarBear(RenderManager p_i47132_1_) {
    ...
    RenderLayerCompat.addLayer(this, new LayerArrowCustomSized(this, 0.8F));
    RenderLayerCompat.addLayer(this, new LayerCustomHeadEngender(((ModelPolarBear)RenderLayerCompat.getMainModel(this)).head, ((ModelPolarBear)RenderLayerCompat.getMainModel(this)).head));
