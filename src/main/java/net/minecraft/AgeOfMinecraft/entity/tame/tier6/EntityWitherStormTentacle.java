    ...
    if (this.residentWitherStorm != null) {
      ...
      if (this.residentWitherStorm.doesntContainACommandBlock()) {
        if (this.residentWitherStorm.tentacle1 != null && this == this.residentWitherStorm.tentacle1)
          setLocationAndAngles(this.residentWitherStorm.posX, this.residentWitherStorm.posY - 2.0D, this.residentWitherStorm.posZ, 0.0F, 0.0F); 
        if (this.residentWitherStorm.tentacle2 != null && this == this.residentWitherStorm.tentacle2)
          setLocationAndAngles(this.residentWitherStorm.posX + (twod * 4.0F), this.posY - 1.0D, this.residentWitherStorm.posZ + (oned * 4.0F), 0.0F, 0.0F); 
        if (this.residentWitherStorm.tentacle3 != null && this == this.residentWitherStorm.tentacle3)
          setLocationAndAngles(this.residentWitherStorm.posX - (twod * -2.0F), this.posY + 4.0D, this.residentWitherStorm.posZ - (oned * -2.0F), 0.0F, 0.0F); 
        if (this.residentWitherStorm.tentacle4 != null && this == this.residentWitherStorm.tentacle4)
          setLocationAndAngles(this.residentWitherStorm.posX + (twod * -5.0F), this.posY + 3.0D, this.residentWitherStorm.posZ + (oned * -5.0F), 0.0F, 0.0F); 
        if (this.residentWitherStorm.tentacle5 != null && this == this.residentWitherStorm.tentacle5)
          setLocationAndAngles(this.residentWitherStorm.posX, this.residentWitherStorm.posY + 2.0D, this.residentWitherStorm.posZ, 0.0F, 0.0F); 
      } else {
        if (this.residentWitherStorm.tentacle1 != null && this == this.residentWitherStorm.tentacle1)
          setLocationAndAngles(this.residentWitherStorm.posX, this.residentWitherStorm.posY - 12.0D, this.posZ, 0.0F, 0.0F); 
        if (this.residentWitherStorm.tentacle2 != null && this == this.residentWitherStorm.tentacle2)
          setLocationAndAngles(this.residentWitherStorm.posX + (twod * 2.0F), this.residentWitherStorm.posY - 8.0D, this.posZ + (oned * 2.0F), 0.0F, 0.0F); 
        if (this.residentWitherStorm.tentacle3 != null && this == this.residentWitherStorm.tentacle3)
          setLocationAndAngles(this.residentWitherStorm.posX - (twod * -8.0F), this.residentWitherStorm.posY + 8.0D, this.posZ - (oned * -8.0F), 0.0F, 0.0F); 
        if (this.residentWitherStorm.tentacle4 != null && this == this.residentWitherStorm.tentacle4)
          setLocationAndAngles(this.residentWitherStorm.posX + (twod * -5.0F), this.residentWitherStorm.posY + 4.0D, this.posZ + (oned * -5.0F), 0.0F, 0.0F); 
        if (this.residentWitherStorm.tentacle5 != null && this == this.residentWitherStorm.tentacle5)
          setLocationAndAngles(this.residentWitherStorm.posX, this.residentWitherStorm.posY + 3.0D, this.residentWitherStorm.posZ, 0.0F, 0.0F); 
      } 
    } 
