...
public class EntityPortal extends EntityTameBase implements IEntityMultiPart, Massive, Armored, Structure {
  private static final DataParameter<Integer> TOWER1_TARGET = EntityDataManager.createKey(EntityPortal.class, DataSerializers.VARINT);
  
  private static final DataParameter<Integer> TOWER2_TARGET = EntityDataManager.createKey(EntityPortal.class, DataSerializers.VARINT);
  
  private static final DataParameter<Integer> TOWER3_TARGET = EntityDataManager.createKey(EntityPortal.class, DataSerializers.VARINT);
  
  private static final DataParameter<Integer> TOWER4_TARGET = EntityDataManager.createKey(EntityPortal.class, DataSerializers.VARINT);
  ...
  private static final DataParameter<Integer> LIGHTNINGTIMER = EntityDataManager.createKey(EntityPortal.class, DataSerializers.VARINT);
