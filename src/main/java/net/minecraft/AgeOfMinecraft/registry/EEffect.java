...
public class EEffect {
  public static final Potion BREAKING = (new PotionEngender("breaking", true, 13015637, 0, 0, -2.0D)).registerPotionAttributeModifier(SharedMonsterAttributes.ARMOR, UUID.fromString("d8e4ae61-e49d-4931-aa67-0e7662665550").toString(), 0.0D, 0);
  ...
  public static final PotionType long_breaking = (new PotionType("breaking", new PotionEffect[] { new PotionEffect(BREAKING, 9600) })).setRegistryName("long_breaking");
  
  public static final PotionType strong_breaking = (new PotionType("breaking", new PotionEffect[] { new PotionEffect(BREAKING, 1800, 1) })).setRegistryName("strong_breaking");
