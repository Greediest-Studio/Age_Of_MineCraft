...
public class ESound {
  ...
  public static SoundEvent girlHurt;
  
  public static SoundEvent girlDeath;
  
  public static SoundEvent girlMoan;
  
  public static SoundEvent guyHurt;
  
  public static SoundEvent guyDeath;
  ...
  public static SoundEvent sansblink;
  
  public static SoundEvent bonelaunch;
  
  public static SoundEvent bonehit;
  
  public static SoundEvent bonewarn;
  
  public static SoundEvent bonerise;
  
  public static SoundEvent gasterblasterspawn;
  
  public static SoundEvent gasterblasterfire;
  
  public static SoundEvent sansthrowimpact;
  
  public static SoundEvent sanstalk;
  ...
  public static void registerSounds() {
    ...
    girlHurt = registerSound("girlHurt");
    girlDeath = registerSound("girlDeath");
    girlMoan = registerSound("girlMoan");
    guyHurt = registerSound("guyHurt");
    guyDeath = registerSound("guyDeath");
    amalgamate = registerSound("amalgamate");
    jzaharshout = registerSound("jzaharshout");
    blast = registerSound("blast");
    sansblink = registerSound("modeswitch");
    bonelaunch = registerSound("bonelaunch");
    bonehit = registerSound("bonehit");
    bonewarn = registerSound("bonewarn");
    bonerise = registerSound("bonerise");
    gasterblasterspawn = registerSound("gasterblasterspawn");
    gasterblasterfire = registerSound("gasterblasterfire");
    sansthrowimpact = registerSound("sansthrowimpact");
    sanstalk = registerSound("sanstalk");
