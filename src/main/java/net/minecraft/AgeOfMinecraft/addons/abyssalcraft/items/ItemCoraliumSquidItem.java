...
public class ItemCoraliumSquidItem extends ItemAbyTier {
  public ItemCoraliumSquidItem() {
    super(2, 16, 32, "coraliumsquid");
  }
  ...
  public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityCoraliumSquid entityliving = new EntityCoraliumSquid(worldIn);
