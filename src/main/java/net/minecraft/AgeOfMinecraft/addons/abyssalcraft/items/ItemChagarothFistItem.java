...
public class ItemChagarothFistItem extends ItemAbyTier {
  public ItemChagarothFistItem() {
    super(2, 32, 48, "chagarothfist");
  }
  ...
  public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    for (int a = 0; a < 2; a++) {
      EntityChagarothFist entityliving = new EntityChagarothFist(worldIn);
