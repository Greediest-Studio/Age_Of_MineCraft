...
public abstract class PhaseBaseFriendly implements IPhaseAsorah {
  protected final EntityDragonBoss dragon;
  
  public PhaseBaseFriendly(EntityDragonBoss dragonIn) {
  ...
  public void onCrystalDestroyed(EntityDragonMinion crystal, BlockPos pos, DamageSource dmgSrc, EntityPlayer plyr) {}
