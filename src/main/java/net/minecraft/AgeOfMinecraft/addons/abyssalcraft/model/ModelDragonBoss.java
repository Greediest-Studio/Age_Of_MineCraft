...
public class ModelDragonBoss extends ModelBase {
  ...
  public ModelDragonBoss(float p_i46360_1_) {
  ...
  public void render(Entity entityIn, float p_78088_2_, float limbSwing, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    EntityDragonBoss entitydragon = (EntityDragonBoss)entityIn;
    ...
    for (int k = 0; k < 12; k++) {
      ...
      this.spine.rotateAngleY = (updateRotations(adouble2[0] - adouble[0]) * f5 + 180.0F) * 0.017453292F;
