...
public class ItemShadowCreatureItem extends ItemAbyTier {
  public ItemShadowCreatureItem() {
    super(2, 15, 32, "shadowcreature");
  }
  ...
  public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityShadowCreature entityliving = new EntityShadowCreature(worldIn);
