  ...
  public void onLivingUpdate() {
    ...
    if (this.world.isRemote)
      for (int i = 0; i < 3 && this.ticksExisted > 60; i++) {
        ...
        if (getMetaData() > 0)
          this.world.spawnParticle(EnumParticleTypes.DRAGON_BREATH, this.posX + (this.rand.nextDouble() - 0.5D) * this.width, this.posY + 1.0D, this.posZ + (this.rand.nextDouble() - 0.5D) * this.width, 0.0D, 0.01D, 0.0D, new int[0]); 
        if (getMetaData() > 1) {
          this.world.spawnParticle(EnumParticleTypes.CRIT, true, this.posX + 3.25D + f + this.rand.nextDouble() - 0.5D, this.posY + 4.0D + this.rand.nextDouble() - 0.5D, this.posZ + 3.25D + f + this.rand.nextDouble() - 0.5D, f * 0.1D, 0.02D, f * 0.1D, new int[0]);
          this.world.spawnParticle(EnumParticleTypes.CRIT, true, this.posX + 3.25D + f + this.rand.nextDouble() - 0.5D, this.posY + 4.0D + this.rand.nextDouble() - 0.5D, this.posZ - 3.25D - f + this.rand.nextDouble() - 0.5D, f * 0.1D, 0.02D, f * 0.1D, new int[0]);
          this.world.spawnParticle(EnumParticleTypes.CRIT, true, this.posX - 3.25D - f + this.rand.nextDouble() - 0.5D, this.posY + 4.0D + this.rand.nextDouble() - 0.5D, this.posZ - 3.25D - f + this.rand.nextDouble() - 0.5D, f * 0.1D, 0.02D, f * 0.1D, new int[0]);
          this.world.spawnParticle(EnumParticleTypes.CRIT, true, this.posX - 3.25D - f + this.rand.nextDouble() - 0.5D, this.posY + 4.0D + this.rand.nextDouble() - 0.5D, this.posZ + 3.25D + f + this.rand.nextDouble() - 0.5D, f * 0.1D, 0.02D, f * 0.1D, new int[0]);
        } 
        if (getMetaData() > 2)
          this.world.spawnParticle(EnumParticleTypes.CRIT_MAGIC, this.posX + (this.rand.nextDouble() - 0.5D) * this.width, this.posY + 1.25D, this.posZ + (this.rand.nextDouble() - 0.5D) * this.width, 1.0D, 0.0D, 0.5D, new int[0]); 
        if (getMetaData() > 3) {
        ...
        this.world.spawnParticle(EnumParticleTypes.SMOKE_LARGE, this.posX + (this.rand.nextDouble() - 0.5D) * this.width, this.posY + 0.8D + this.rand.nextDouble() * this.height, this.posZ + (this.rand.nextDouble() - 0.5D) * this.width, 0.0D, 0.25D, 0.0D, new int[0]);
        this.world.spawnParticle(EnumParticleTypes.SPELL_INSTANT, this.posX + (this.rand.nextDouble() - 0.5D) * this.width, this.posY + 0.8D, this.posZ + (this.rand.nextDouble() - 0.5D) * this.width, 0.0D, 0.05D, 0.0D, new int[0]);
        this.world.spawnParticle(EnumParticleTypes.SPELL_INSTANT, this.posX + (this.rand.nextDouble() - 0.5D) * this.width, this.posY + 0.8D, this.posZ + (this.rand.nextDouble() - 0.5D) * this.width, 0.0D, 0.05D, 0.0D, new int[0]);
