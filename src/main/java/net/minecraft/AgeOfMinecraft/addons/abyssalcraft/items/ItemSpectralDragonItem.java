...
public class ItemSpectralDragonItem extends ItemAbyTier {
  public ItemSpectralDragonItem() {
    super(3, 50, 20, "spectraldragon");
  }
  ...
  public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    EntityDragonMinion entityliving = new EntityDragonMinion(worldIn);
