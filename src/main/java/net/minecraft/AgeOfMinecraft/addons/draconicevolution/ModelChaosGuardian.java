...
public class ModelChaosGuardian extends ModelBase {
  ...
  public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
    ...
    float Pitch = p_78088_6_ / 57.295776F;
    ...
    if (entitydragon.getJukeboxToDanceTo() != null) {
      this.jaw.rotateAngleX = (float)(Math.sin((f * 6.2831855F)) + 1.0D) * 0.3F;
      p_78088_6_ = 15.0F + (float)(Math.sin((f * 6.2831855F) + Math.PI) + 1.0D) * 15.0F;
    } 
    ...
    float f3 = -12.0F;
    for (int i = 0; i < 5; i++) {
      Pitch = -p_78088_6_ * -0.0021816615F * (2 + i);
    ...
    if (entitydragon.getJukeboxToDanceTo() != null) {
      GlStateManager.rotate(MathHelper.cos(f * 3.1415927F) * 30.0F, 0.0F, 0.0F, 1.0F);
    ...
    for (int j = 0; j < 2; j++) {
      ...
      this.rearLeg.rotateAngleZ = (entitydragon.getJukeboxToDanceTo() != null) ? ((j == 1) ? ((float)Math.cos((f * 3.1415927F + 1.0F)) * 0.75F) : -((float)Math.cos((f * 3.1415927F + 1.0F)) * 0.75F)) : 0.0F;
      this.rearLegTip.rotateAngleZ = (entitydragon.getJukeboxToDanceTo() != null) ? ((j == 1) ? ((float)Math.cos((f * 3.1415927F + 2.0F)) * 0.5F) : -((float)Math.cos((f * 3.1415927F + 2.0F)) * 0.5F)) : 0.0F;
      this.rearFoot.rotateAngleZ = (entitydragon.getJukeboxToDanceTo() != null) ? ((j == 1) ? ((float)Math.cos((f * 3.1415927F + 3.0F)) * 0.5F) : -((float)Math.cos((f * 3.1415927F + 3.0F)) * 0.5F)) : 0.0F;
      this.frontLeg.rotateAngleZ = (entitydragon.getJukeboxToDanceTo() != null) ? (1.0F - (float)Math.cos(f11)) : 0.0F;
      this.frontLeg.rotateAngleX = (entitydragon.isSneaking() ? -1.3F : 1.3F) + f1 * 0.1F - ((entitydragon.getJukeboxToDanceTo() != null) ? 2.0F : 0.0F);
      this.frontLegTip.rotateAngleZ = (entitydragon.getJukeboxToDanceTo() != null) ? -0.5F : 0.0F;
      this.frontLegTip.rotateAngleX = (entitydragon.isSneaking() ? 2.5F : -0.5F) - f1 * 0.1F;
      this.frontFoot.rotateAngleX = 0.75F + f1 * 0.1F + ((entitydragon.getJukeboxToDanceTo() != null) ? 0.5F : 0.0F);
    ...
    for (int k = 0; k < 12; k++) {
      ...
      this.spine.rotateAngleY = (updateRotations(adouble2[0] - adouble[0]) * f5 + 180.0F) * 0.017453292F + ((entitydragon.getJukeboxToDanceTo() != null) ? ((float)Math.cos((f * 6.2831855F - k * 0.25F)) * 0.75F) : 0.0F);
