...
public class LayerDraconicPortalOverlay implements LayerRenderer<EntityLivingBase> {
  ...
  private final RenderDraconicPortal renderer;
  
  private ModelPortal layerModel;
  
  public LayerDraconicPortalOverlay(RenderDraconicPortal p_i46109_1_) {
    this.renderer = p_i46109_1_;
    this.layerModel = new ModelPortal(true);
  }
  
  public void func_177148_a(EntityDraconicPortal entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
